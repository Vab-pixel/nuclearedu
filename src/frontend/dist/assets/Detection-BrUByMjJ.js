import { r as reactExports, j as jsxRuntimeExports, P as PageHeader, S as SectionCard, E as EquationBlock, h as ChevronDown, g as ChevronRight } from "./index-DTpTSWSe.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-10 max-w-4xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionCard, { "data-ocid": "detection.intro_card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-3", children: "For an ionization chamber collecting charge, the measured current is directly related to the ion-pair production rate:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          EquationBlock,
          {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 space-y-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-3", children: [
                "Energy resolution",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "R\\\\,(\\%) = \\\\frac{\\\\text{FWHM}}{E_{\\\\text{peak}}} \\\\times 100" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border bg-muted/20 p-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-2", children: [
                    "A calibrated multi-nuclide source (e.g., NIST-traceable Eu-152 point source) is counted in the exact geometry used for samples. Full-energy peak efficiency",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "\\\\varepsilon(E) = \\\\frac{N_{\\\\text{net}}}{A \\\\cdot I_\\\\gamma \\\\cdot t}" }),
                    " ",
                    "where A is source activity (Bq), × I_γ × time). Efficiency is fit as a smooth function of energy (polynomial in log–log space). Absolute activity of unknowns:"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    EquationBlock,
                    {
