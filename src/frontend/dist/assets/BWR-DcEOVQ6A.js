import { r as reactExports, j as jsxRuntimeExports, P as PageHeader, S as SectionCard, E as EquationBlock, A as AudienceBadge, i as SafetyCallout, h as ChevronDown, g as ChevronRight } from "./index-DWzjlv-D.js";
const systems = [
  {
...
function BWRPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-10 max-w-4xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionCard, { "data-ocid": "bwr.physics_equations_card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-semibold text-foreground mb-4", children: "BWR Physics: Void Reactivity & Thermal-Hydraulics" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-2", children: "The BWR’s defining physics is the two-phase boiling within the core. Void fraction, steam quality, and boiling heat transfer govern stability and control:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          EquationBlock,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md bg-muted/30 border border-border px-4 py-3 my-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mb-2", children: "BWR Typical Operating Parameters" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-2 text-sm text-muted-foreground", children: [
          ...
          ].map(([p, v, d]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-primary shrink-0", children: p }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold shrink-0", children: v }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs self-center", children: d })
          ] }, p)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-muted-foreground italic", children: "Source: GE BWR/6 General Description; IAEA Nuclear Power Reactors in the World 2023." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-semibold text-foreground mt-4 mb-2", children: "ECCS Systems" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-2", children: "The BWR Emergency Core Cooling System (ECCS) consists of three independent, redundant subsystems:" }),
        ...
        ].map(([abbr, name, desc]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "rounded-lg border border-border bg-muted/20 p-3 text-sm",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-semibold text-primary", children: abbr }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 font-semibold text-foreground", children: name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1", children: desc })
            ]
          },
          abbr
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-muted-foreground italic", children: "Source: GE ABWR Design Control Document, Rev. 3; 10 CFR 50 Appendix K." })
      ] }),
