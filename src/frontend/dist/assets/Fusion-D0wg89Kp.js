import { j as jsxRuntimeExports, P as PageHeader, S as SectionCard, E as EquationBlock, r as reactExports, h as ChevronDown, g as ChevronRight } from "./index-DTpTSWSe.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed mb-5", children: [
              "ITER is the world's most complex scientific project, representing humanity's most ambitious attempt to demonstrate the scientific and technological feasibility of fusion energy. A 35-nation collaboration (EU-27, UK, Switzerland, China, India, Japan, South Korea, Russia, USA) is constructing the machine at Cadarache in the south of France, backed by a budget exceeding",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "$22 billion USD" }),
              " — making it one of the most expensive scientific instruments in history, alongside the Large Hadron Collider and the James Webb Space Telescope."
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Scientific Goal: Prove Q ≥ 10 is Achievable" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: [
              "ITER will not generate electricity — it is a scientific experiment designed to demonstrate burning plasma physics at scale. Its mission is to prove that more fusion energy can be extracted than heating energy injected by a factor of at least 10. ITER is designed to produce",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "500 MW of fusion power" }),
              " ",
              "from only",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "50 MW of external heating" }),
              " ",
              '(NBI + ICRF + ECRH), sustaining this for 400–600 second pulses — long enough to study "burning plasma" physics where the plasma heats itself predominantly via alpha-particle deposition rather than external heating.'
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              EquationBlock,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3 mt-5", children: "D-T Fuel Cycle" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: [
              "ITER will consume approximately",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "0.5 kg of D-T fuel per day" }),
              " ",
              "during full D-T operation to produce 500 MW of fusion power (~10⁸ J/s = ~24 GWh/day). Deuterium (D) is readily separated from seawater; tritium (T) is the challenging component:"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-muted/20 border border-border p-4 mb-5 text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground block mb-2", children: "Tritium Supply for ITER" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: `ITER requires ~0.35 kg T/day during D-T campaigns. Global tritium supply is ~25 kg (from CANDU reactor production, stored primarily at Chalk River Isotopes and SRB Technologies in Canada). ITER's tritium needs are supplied from existing stockpiles — it will not breed its own tritium (ITER blankets are "test blanket modules" for R&D, not full breeding blankets). DEMO will need a tritium breeding blanket, making breeding technology demonstration one of ITER's secondary objectives.` })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Key Subsystems" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-3 mb-5", children: [
              {
                name: "Superconducting magnets (TF coils)",
                detail: "18 Nb₃Sn toroidal field coils at 4 K (−269 °C), generating 5.3 T on-axis (11.8 T at coil face). Nb₃Sn enables ITER's field — impossible with conventional NbTi magnets in this geometry."
              },
              {
                name: "Poloidal field (PF) coils",
                detail: "6 large PF coils + central solenoid (NbTi); plasma current is inductively driven to 15 MA by the central solenoid — the world's most powerful pulsed electromagnet at 13 T."
              },
              {
                name: "Blanket modules",
                detail: "440 blanket modules cover the plasma-facing first wall. Primary shielding function; test blanket modules (TBMs) from multiple nations test lithium-ceramic and lithium-lead breeding concepts."
              },
              {
                name: "Divertor",
                detail: "54 tungsten/carbon divertor cassettes at the bottom of the plasma vessel; absorbs particle and heat flux from the scrape-off layer plasma; handles 10–20 MW/m² peak heat flux."
              },
              {
                name: "Heating systems (50 MW)",
                detail: "NBI (neutral beam injection): 33 MW at 1 MeV D°. ICRF (ion cyclotron resonance frequency): 20 MW at 40–55 MHz. ECRH (electron cyclotron resonance heating): 20 MW at 170 GHz."
              },
              {
                name: "Vacuum vessel",
                detail: "Primary confinement barrier; double-walled stainless steel; 8,500 tonnes; 840 m³ plasma volume; built in 9 sectors shipped from USA, Korea, India, Europe."
              }
            ].map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground text-sm mb-1", children: v.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: v.detail })
                ]
              },
              v.name
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Construction Timeline" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 mb-4 text-sm", children: [
              ...
              {
                year: "2020–2024",
                event: "Assembly phase: vacuum vessel sectors, TF coils, cryostat"
              },
              {
                year: "~2027",
                event: "First plasma (hydrogen, non-nuclear — machine commissioning; no D-T at this stage)"
              },
              {
                year: "~2029–2032",
                event: "PFPO-1 phase: deuterium-deuterium plasmas; heating power integration"
              },
              {
                year: "~2035",
                event: "PFPO-2 / DT-1: First D-T plasmas; target Q ≥ 10 burning plasma demonstration"
              }
            ].map((step) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-primary font-semibold w-20 shrink-0", children: step.year }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: step.event })
                ]
              },
              step.year
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-3", children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "ITER — The Way to New Energy" }),
              ", ITER IO Publication; Bigot, B. (2022) ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Nature" }),
              " 599, 368."
            ] })
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed mb-5", children: [
              "On December 5, 2022, the National Ignition Facility (NIF) at Lawrence Livermore National Laboratory (LLNL) achieved a landmark in 66 years of fusion research: a fusion implosion that produced",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "3.15 MJ of fusion energy from 2.05 MJ of laser energy" }),
              ', achieving a plasma Q > 1 (Q ≈ 1.54) for the first time in history. This milestone — termed "ignition" (Q_laser > 1) by the scientific community — demonstrated that a burning plasma on Earth was physically achievable via laser-driven inertial confinement fusion (ICF).'
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "NIF Specifications" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5", children: [
              { label: "Laser Beams", value: "192", sub: "UV, 351 nm (3ω)" },
              {
                label: "Max Energy",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "ICF Principle: Compression, Hot Spot, Burn Wave" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreforward text-sm leading-relaxed mb-3", children: [
              "ICF achieves fusion not by confining a hot plasma for seconds (magnetic confinement), but by",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "compressing a tiny D-T target so rapidly" }),
              " ",
              "that fusion reactions complete before the plasma can expand — confined by its own inertia during the ~10 ns implosion. The NIF uses the indirect-drive approach:"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 mb-5 text-sm text-muted-foreground", children: [
              {
              ...
              "div",
              {
                className: "flex gap-3 rounded-lg bg-muted/20 border border-border p-3",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-primary font-semibold shrink-0 w-40", children: item.step }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.desc })
                ]
              },
              item.step
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3 mt-5", children: "NIF Experimental Milestones" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-lg border border-border mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: [
                ...
                "tr",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-muted-foreground", children: row[1] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-muted-foreground", children: row[2] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 font-mono text-primary", children: row[3] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-muted-foreground", children: row[4] })
                  ]
                },
                String(row[0])
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Challenges on the Path to an IFE Power Plant" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: "NIF's Q ≈ 1.54 is a landmark physics result, but a commercial inertial fusion energy (IFE) power plant faces engineering hurdles of many orders of magnitude beyond the NIF:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-3 mb-4", children: [
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground mb-2", children: c.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wide block text-muted-foreground/60 mb-1", children: "Current" }),
                    c.current
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wide block text-muted-foreground/60 mb-1", children: "Required" }),
                    c.required
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-primary text-xs font-semibold", children: [
                    "Gap: ",
                    c.gap
                  ] })
                ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Other ICF Approaches" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-3", children: [
              ...
              " 601, 542; Abu-Shawareb et al. (2022) ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Phys. Rev. Lett." }),
              " 129, 075001; Hurricane et al. (2023) ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-5", children: "While tokamaks dominate the magnetic confinement fusion landscape, stellarators and a diverse ecosystem of alternative approaches are attracting renewed interest — for different reasons. Stellarators offer steady-state operation and intrinsic disruption-freedom; compact private ventures leverage new materials science and computational design to challenge the traditional large-tokamak model." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Stellarator vs. Tokamak: Key Distinction" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-muted/30 border border-border p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground text-sm mb-2", children: "Tokamak" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-1 text-xs text-muted-foreground list-disc list-inside", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Requires a large plasma current (15 MA in ITER) to create the poloidal field for helical confinement" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Plasma current is unstable — must be actively controlled against disruptions (sudden loss of current and confinement)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Inherently pulsed (inductive drive); steady-state requires auxiliary current drive (bootstrap + ECCD/NBCD) — challenging" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Simpler coil geometry but complex plasma control; decades of operational experience" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-primary/5 border border-primary/20 p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground text-sm mb-2", children: "Stellarator" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-1 text-xs text-muted-foreground list-disc list-inside", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "No plasma current required — helical field entirely produced by complex 3D external coil geometry optimised by computation" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Intrinsically steady-state: no inductive drive, no plasma current to lose — no disruptions possible" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Lower stored magnetic energy in plasma — inherently safer" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Complex, precisely shaped non-planar coils: historically impossible to manufacture; now feasible with modern CNC fabrication and advanced computing" })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Wendelstein 7-X (W7-X): World's Largest Optimised Stellarator" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: "Wendelstein 7-X at the Max Planck Institute for Plasma Physics in Greifswald, Germany, is the culmination of decades of stellarator optimization theory. W7-X is the largest and most precisely built stellarator in the world, designed to demonstrate that a quasi-isodynamically optimised stellarator can confine plasma as well as — or better than — a comparably sized tokamak." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-3 mb-5", children: [
              ["Major radius", "5.5 m"],
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Compact Fusion: The Private Sector Approach" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: "The insight driving private fusion companies: ITER-scale devices (~€20B, 35 nations, 30-year timeline) are not the only path. If higher magnetic fields are achievable (via HTS magnets), plasma confinement scales as B⁴, allowing fusion-relevant conditions in a much smaller, cheaper device. Commonwealth Fusion Systems (CFS) is the leading HTS tokamak company:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-lg border border-border mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "bg-muted/40 border-b border-border", children: [
                "Company",
                "Concept",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Private Fusion Investment: 2022–2024" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: "Fusion Industry Association (FIA) Annual Reports show explosive growth in private fusion investment:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 mb-5", children: [
              ...
              "div",
              {
                className: "rounded-lg bg-muted/30 border border-border p-4 text-center",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-wider text-muted-foreground mb-1", children: s.year }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-xl font-bold text-primary", children: s.amount }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1", children: s.note })
                ]
              },
              s.year
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-2", children: "Realistic Timeline to Commercial Fusion Power" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "The Fusion Industry Association's 2023 survey of fusion scientists found median estimates of 2040–2045 for first commercial fusion electricity. The most optimistic scenario (CFS/Helion): electricity from fusion by 2035. The ITER/DEMO pathway: first electricity demonstration ~2050. Sober assessment: fusion is closer than ever but remains contingent on materials science breakthroughs (14 MeV neutron damage), tritium breeding validation, and sustained capital through inevitable experimental setbacks." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-3", children: [
              "Sources: Fusion Industry Association,",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Global Fusion Industry Report 2023" }),
              "; ",
              "Pedersen, T.S. et al. (2022) W7-X ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Phys. Rev. Lett." }),
              " 128, 085003",
              "; ",
              "Klinger, T. et al. (2023) W7-X progress ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Nucl. Fusion" }),
              " 63, 112023."
            ] })
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-5", children: "One of fusion's most compelling attributes is the near-inexhaustibility of its fuel. Deuterium is effectively unlimited; tritium must be bred from lithium, which is abundant globally. The true challenge is not fuel supply but net energy: can a fusion power plant deliver more electricity to the grid than it consumes?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Deuterium: Extracted from Seawater" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: "Deuterium occurs naturally in seawater at a ratio of approximately 1 in 6,420 hydrogen atoms — corresponding to 33 mg of D per litre of seawater. Electrolytic or chemical isotope separation (Girdler sulfide process) extracts D₂O (heavy water) from ordinary water at industrial scale. Key facts:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg bg-muted/20 border border-border p-4 mb-5 text-sm text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-3 gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground block", children: k }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: v })
            ] }, String(k))) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Tritium: Bred from Lithium-6" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: "Tritium (T½ = 12.32 years) does not exist in nature in useful quantities. First-generation D-T fusion reactors must breed their own tritium from lithium using the fusion neutrons:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              EquationBlock,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: [
              "Li-7, which constitutes 92.4% of natural lithium, also breeds tritium at higher neutron energies:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs bg-muted/40 px-1 rounded", children: "⁷Li + n → ⁴He + T + n − 2.47 MeV" }),
              " ",
              "(endothermic; threshold ~2 MeV). This reaction also regenerates a neutron, allowing a breeding ratio > 1 from a natural lithium blanket."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Lithium Resources" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-3 gap-3 mb-5", children: [
              {
                label: "Land reserves",
                value: "~22 Mt",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: "At 130 kg Li/yr per GWe plant, and 100 GWe of global fusion capacity, annual consumption would be ~13,000 tonnes of Li (predominantly Li-6). World land reserves of ~22 million tonnes could support ~1,700 years of such consumption. Even without ocean extraction, lithium for fusion is effectively unlimited on civilisation timescales." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Net Energy Economics: Wall-Plug to Grid" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: "The distinction between plasma Q (fusion energy / heating energy) and wall-plug Q (fusion energy / total electricity consumed) is critical for evaluating commercial viability:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 mb-5 text-sm", children: [
              {
                step: "Plasma Q ≥ 10",
              ...
              "div",
              {
                className: "flex gap-3 rounded-lg bg-muted/20 border border-border p-3",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground text-xs uppercase tracking-wide w-40 shrink-0 pt-0.5", children: item.step }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: item.desc })
                ]
              },
              item.step
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-2", children: "Grid Parity Projections" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "Levelised Cost of Energy (LCOE) projections for first-of-a-kind (FOAK) fusion power plants: European DEMO studies estimate €60–80/MWh for the first commercial plant (2050s), declining to ~€40/MWh for nth-of-a-kind (NOAK) as learning curve effects reduce capital costs. This is competitive with nuclear fission and offshore wind on a long-run marginal cost basis, but capital intensity remains the key risk. Fuel costs (~$0.10/GJ for D; ~$40/GJ for bred T) would be essentially negligible in the LCOE compared to capital charges." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-4", children: [
              "Sources: USGS Mineral Commodity Summaries 2023 (Lithium); Franza, F. et al. (2022) Fusion Engineering and Design 134; Fusion Industry Association, ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Global Fusion Industry Report 2023" }),
              "."
            ] })
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-5", children: "The fundamental challenge of fusion is simple: two positively charged nuclei must approach each other close enough for the strong nuclear force to bind them. But the electromagnetic (Coulomb) repulsion between them creates an enormous energy barrier that must be overcome or tunneled through." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              EquationBlock,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3 mt-5", children: "Why Stars Can Fuse at Lower Temperatures" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: "The Sun's core temperature is only ~15 million °C (1.3 keV) — far below the optimal D-T fusion temperature. Stars use the proton-proton chain, which has an extremely low cross-section compensated by the Sun's enormous density (~150 g/cm³), huge volume, and the weak nuclear force mediating the p+p → D reaction. The Sun produces only ~276 W/m³ of power — less than a compost pile. Terrestrial fusion must achieve much higher power density, requiring much higher plasma temperature." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3 mb-5", children: [
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-3", children: "Thermally Averaged Reaction Rate" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              EquationBlock,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-3", children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "The Physics of Inertial Fusion" }),
              " (2004); Glasstone & Lovberg,",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Controlled Thermonuclear Reactions" }),
              " (1960); Bosch & Hale,",
              " ",
