import { j as jsxRuntimeExports, k as Badge, e as Atom, Z as Zap, G as Globe, p as Shield, l as Rocket, r as reactExports, h as ChevronDown, g as ChevronRight } from "./index-DTpTSWSe.js";
...
const ERAS = [
  {
    ...
    events: [
      ...
      },
      {
        ...
        description: "Ernest Rutherford (Manchester) achieves the first artificial nuclear transmutation. Alpha particles from radium strike nitrogen-14 gas, producing oxygen-17 and a proton — the first time humanity deliberately converts one element into another. Q-value ≈ −1.19 MeV (endothermic).",
        detail: "In modern notation: ¹⁴N(α,p)¹⁷O. The Q-value is approximately −1.19 MeV (endothermic) — the alpha particle must carry sufficient kinetic energy to overcome both the Coulomb barrier and the reaction threshold. This experiment proved nuclear transmutation was achievable without a particle accelerator.",
