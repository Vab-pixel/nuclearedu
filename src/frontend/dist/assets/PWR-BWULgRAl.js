...
const EqBlock = ({ content, note }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-4 p-4 bg-muted/20 rounded border border-border", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "font-mono text-sm whitespace-pre-wrap text-foreground", children: content }),
  note && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-muted-foreground text-xs", children: note })
] });
function PWRPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-10 max-w-4xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionCard, { "data-ocid": "pwr.physics_equations_card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-semibold text-foreground mb-4", children: "Core Reactor Physics Equations" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-2", children: "The behavior of a PWR core is governed by coupled neutron kinetics, thermal-hydraulics, and reactivity feedback. Key governing equations:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          EquationBlock,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md bg-muted/30 border border-border px-4 py-3 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mb-2", children: "Typical Operating Parameters (1,000 MWe PWR)" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-muted-foreground italic", children: "Source: IAEA Nuclear Power Reactors in the World 2023; NUREG/CR-6944." })
        ] })
      ] }),
