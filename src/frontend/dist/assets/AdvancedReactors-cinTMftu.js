import { j as jsxRuntimeExports, f as Link, g as ChevronRight, k as Badge, e as Atom, Z as Zap, G as Globe, l as Rocket, F as FlaskConical, r as reactExports, h as ChevronDown, E as EquationBlock } from "./index-DTpTSWSe.js";
...
const Equation = ({
  ...
  label,
  note
}) => /* @__PURE__ */ jsxRuntimeExports.jsx(EquationBlock, { latex: formula, annotation: note ?? label });
function DataTable({
  headers,
  rows
}) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-6 py-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Collapsible,
            {
              ...
              id: "key-equations",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-5", children: "Advanced reactors are distinguished by their efficiency and fuel utilisation. Three fundamental equations govern the thermodynamics and fuel cycle of Generation IV and SMR designs." }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  SubSection,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-lg border border-border my-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "bg-muted/50", children: [
                          "Reactor Type",
                          "T_hot (°C)",
                          "T_cold (°C)",
                          "η_Carnot",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Higher outlet temperature is the primary driver of efficiency improvement in advanced reactors. Each additional 100 °C of outlet temperature corresponds to approximately 2–5% absolute increase in thermal efficiency for practical steam/gas cycles. IAEA-TECDOC-1561, 2007." })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  SubSection,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-3 gap-3 my-4", children: [
                        {
                          reactor: "LWR (PWR/BWR)",
                          br: "~0.55–0.65",
                        ...
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground text-xs mb-1", children: s.reactor }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-primary text-base font-bold", children: [
                              "BR ≈ ",
                              s.br
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs mt-1", children: s.note })
                          ]
                        },
                        s.reactor
                      )) })
                  ...
                  SubSection,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4 mb-4", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground text-sm mb-2", children: "TRISO Particle Architecture" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-2", children: "TRISO (Tri-structural ISO-tropic) particles consist of a uranium (or Th/U) fuel kernel surrounded by four concentric protective layers. The SiC layer is the primary pressure vessel — retaining fission gases and metallic fission products at temperatures up to 1,600°C. Failure fraction <10⁻⁵ per particle is the design standard." }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "space-y-1 text-xs text-muted-foreground list-decimal list-inside", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "UO₂/UCO/ThO₂ kernel" }),
                              " ",
                              "— fissile fuel source (~300–600 μm)"
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Porous PyC buffer" }),
                              " ",
                              "— absorbs fission recoil, accommodates swelling"
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Inner dense PyC (IPyC)" }),
                              " ",
                              "— structural protection; prevents Cl⁻ attack on SiC"
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "SiC layer (~35 μm)" }),
                              " ",
                              "— primary fission product barrier; 2600°C melting point"
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Outer dense PyC (OPyC)" }),
                              " ",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground text-sm mb-2", children: "Metallic Fuel (SFR/EBR-II Heritage)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-2", children: "U-Zr and U-Pu-Zr metallic alloy fuel (used in EBR-II, tested at INL) offers higher heavy metal density than oxide fuel, enabling very high burnup (>200 GWd/tHM) and improved neutron economy in fast reactors. TerraPower's Natrium uses metallic U-Zr fuel at ~16.5% enrichment." }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-1 text-xs text-muted-foreground list-disc list-inside", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Higher thermal conductivity than UO₂ — lower peak fuel temperature" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Excellent swelling accommodation via plenum volume design" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Compatible with sodium coolant; pyroprocessing recycling pathway" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "EBR-II operated 30 years on metallic fuel without a cladding failure from fuel cause" })
                          ] })
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                        "Sources: IAEA-TECDOC-1854 (TRISO fuel performance); Walters, L.C. (1999) Metallic fuel for fast reactors, ",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "J. Nucl. Mater." }),
                        " ",
                        "270; Carmack, W.J. et al. (2009) Metallic fuels for advanced reactors."
                      ] })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  SubSection,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-3", children: 'The combination of strong negative Doppler and moderator temperature coefficients with passive decay heat removal (natural circulation or conduction cooling) defines the "walk-away safe" property claimed by Generation IV and SMR designs. Under any conceivable accident scenario, these reactors self-shutdown and self-cool without operator action, pumps, or external power.' })
                    ]
                  }
                )
              ]
