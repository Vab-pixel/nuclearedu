import { w as createLucideIcon, j as jsxRuntimeExports, k as Badge, e as Atom, Z as Zap, G as Globe, r as reactExports, h as ChevronDown, g as ChevronRight, E as EquationBlock } from "./index-DTpTSWSe.js";
...
const FlameKindling = createLucideIcon("flame-kindling", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Equation({ tex, label }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EquationBlock, { latex: tex, label }) });
}
const milestones = [
  {
    id: "1",
