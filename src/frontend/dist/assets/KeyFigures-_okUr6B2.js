import { d as createLucideIcon, j as jsxRuntimeExports, C as ChevronRight, A as Atom, F as FlaskConical, M as Microscope, Z as Zap, S as Shield, r as reactExports, b as Badge, a as ChevronDown, f as BookOpen } from "./index-jNE18aF1.js";
import { G as Globe } from "./globe-B-eKmChO.js";
/**
...
const figures = [
  {
    ...
    overview: "On a cloudy February day in 1896, Becquerel accidentally left uranium-bearing crystals on a wrapped photographic plate. When he developed the plate days later, he found a dark patch — uranium had exposed the film without any sunlight. That accidental discovery revealed that matter could emit radiation spontaneously, without any external trigger. He had found radioactivity.",
    ...
    education: "École Polytechnique (1872) and École des Ponts et Chaussées; appointed professor at the Muséum National d'Histoire Naturelle (1892) and at the École Polytechnique (1895).",
    keyContributions: [
      {
      ...
      },
      {
        ...
        detail: "Initially called 'uranic rays' or 'Becquerel rays,' the emitted radiation was later identified as a mixture of beta particles (fast electrons from ²³⁴Pa in the U-238 decay chain) and gamma rays. The SI unit of radioactivity, the becquerel (Bq), is defined as one nuclear disintegration per second."
      },
      {
        title: "Biological effect",
        detail: "In 1901 Becquerel accidentally burned his skin by carrying a radium sample (given by Pierre Curie) in his waistcoat pocket for six hours — the first recorded evidence of radiation-induced skin injury in a person."
      }
    ],
    publications: [
      {
        citation: "Becquerel, H. (1896). Sur les radiations émises par phosphorescence. Comptes Rendus, 122, 420–421.",
        note: "First announcement of the discovery."
      },
      {
        citation: "Becquerel, H. (1896). Sur les radiations invisibles émises par les corps phosphorescents. Comptes Rendus, 122, 501–503."
      }
    ],
    awards: [
  ...
  },
  {
    ...
    keyContributions: [
      ...
      },
      {
        ...
        detail: "Curie founded the Institut du Radium in Paris (now the Institut Curie), still one of the world's leading cancer research and treatment centers, and a sister institute in Warsaw (1932)."
      }
    ],
    publications: [
      {
        citation: "Curie, P., & Curie, M. (1898). Sur une substance nouvelle radio-active, contenue dans la pechblende. Comptes Rendus, 127, 175–178.",
        note: "Announcement of polonium."
      },
      {
        citation: "Curie, P., Curie, M., & Bémont, G. (1898). Sur une nouvelle substance fortement radio-active, contenue dans la pechblende. Comptes Rendus, 127, 1215–1217.",
        note: "Announcement of radium."
      },
      {
        citation: "Curie, M. (1903). Recherches sur les substances radioactives. PhD Thesis, University of Paris.",
  ...
  },
  {
    ...
    keyContributions: [
      ...
      },
      {
        ...
        detail: "Rutherford discovered that the rate of radioactive decay follows an exponential law and introduced the concept of half-life (T½) — the time after which half of any given quantity of a radionuclide has decayed. This was the first quantitative law of nuclear decay:\nN(t) = N₀ · e^(−λt),  where λ = ln2 / T½."
      },
      {
        title: "Transmutation theory (1902, with Soddy)",
        detail: "Rutherford and Frederick Soddy showed that radioactive decay involved the actual transformation of one element into another — directly contradicting the fundamental chemical belief in the immutability of elements. Their paper 'The Cause and Nature of Radioactivity' won Rutherford the 1908 Nobel Prize."
      },
      {
    ...
    publications: [
      ...
      {
        citation: "Rutherford, E., & Soddy, F. (1902). The Cause and Nature of Radioactivity. Philosophical Magazine, 4(21), 370–396."
      },
      {
    ...
    legacy: "Rutherford's laboratory produced more Nobel laureates than almost any other in history — Geiger, Chadwick, Bohr, Hahn, and many others trained under him. Rutherfordium (Rf, Z=104) is named in his honor. His nuclear model remains the foundation of all modern nuclear physics and chemistry.",
  ...
  },
  {
    ...
    keyContributions: [
      {
        ...
        detail: "Bohr postulated that electrons occupy discrete quantized orbits around the nucleus, and that radiation is emitted or absorbed only when electrons transition between orbits. The energy of a photon emitted in a transition from orbit n₂ to n₁ is given by:\nE = hcR_∞(1/n₁² − 1/n₂²)\nwhere R_∞ is the Rydberg constant. This model correctly reproduced the entire hydrogen emission spectrum (Lyman, Balmer, Paschen series) from first principles — a breakthrough that could not be explained by classical physics."
      },
      {
      ...
      },
      {
        ...
        detail: "Bohr proposed that when a neutron is captured by a nucleus, the energy is rapidly shared among all nucleons, forming a 'compound nucleus' in an excited state that decays independently of how it was formed. This model successfully explains nuclear reactions at low to intermediate energies."
      },
      {
    ...
    publications: [
      {
        citation: "Bohr, N. (1913). On the constitution of atoms and molecules. Philosophical Magazine, 26(151), 1–25.",
        note: "The Bohr model."
      },
      {
        citation: "Bohr, N., & Wheeler, J.A. (1939). The mechanism of nuclear fission. Physical Review, 56(5), 426–450.",
        note: "Liquid drop model of fission; identifies U-235 as the fissile isotope."
      },
      {
        citation: "Bohr, N. (1950). Open Letter to the United Nations. Copenhagen.",
    ...
    legacy: "The Niels Bohr Institute in Copenhagen remains one of the world's premier theoretical physics institutions. Bohrium (Bh, Z=107) is named in his honor. His framework for thinking about the relationship between observation and physical reality has influenced philosophy of science as much as physics itself.",
  ...
  },
  {
    ...
    overview: "Lise Meitner spent 30 years as Otto Hahn's scientific partner in Berlin, making fundamental contributions to radioactive decay chains, beta spectra, and nuclear isomers. Forced to flee Nazi Germany in 1938, she was in Swedish exile when Hahn wrote to tell her he had found barium in a uranium bombardment experiment. Over Christmas, she and her nephew Otto Frisch worked out the explanation — a nucleus splitting in two, releasing ~200 MeV. They named the process 'nuclear fission.' Meitner was unjustly excluded from the 1944 Nobel Prize that went to Hahn alone.",
    ...
    keyContributions: [
      {
        ...
        detail: "Meitner and Hahn identified protactinium (Pa, Z=91) as the long-lived parent of actinium in the actinium decay series, completing the understanding of the three natural radioactive series (U-238, U-235/actinium, and Th-232)."
      },
      {
        title: "Beta decay spectra — establishing the neutrino problem (1922–1927)",
        detail: "Meitner showed through painstaking measurements that beta decay produces a continuous energy spectrum, not discrete lines. This was in apparent contradiction with energy conservation — a paradox resolved only by Pauli's 1930 neutrino hypothesis. Her precise measurements were essential data that forced the community to take the problem seriously."
      },
      {
        title: "Discovery of nuclear isomerism (1936)",
        detail: "Meitner discovered that an atomic nucleus can exist in a metastable excited state (same Z and A as the ground state, but with different spin or energy) — nuclear isomerism. This is the basis for modern nuclear medicine: ⁹⁹ᵐTc, the most widely used medical imaging radioisotope, is a nuclear isomer."
      },
      {
        title: "Theoretical explanation of nuclear fission (December 1938 – February 1939)",
      ...
      },
      {
        ...
        detail: 'Meitner and Frisch published their explanation in Nature on 11 February 1939: "Disintegration of Uranium by Neutrons: A New Type of Nuclear Reaction." Within weeks, physicists worldwide were reproducing the result. Bohr, hearing the news, called it "the most important discovery of the century."'
      }
    ],
    publications: [
      {
      ...
      {
        citation: "Hahn, O., & Meitner, L. (1918). Die Muttersubstanz des Actiniums, ein neues radioaktives Element von langer Lebensdauer. Physikalische Zeitschrift, 19, 208.",
  ...
  },
  {
    ...
    overview: "Fermi was arguably the last physicist equally at home in theory and experiment. He built the statistical framework for quantum particles, worked out the theory of beta decay, discovered that slow neutrons dramatically increase reaction rates, and then — in a squash court beneath a Chicago football stadium — directed the world's first self-sustaining nuclear chain reaction. His chain reaction telegram remains one of the most cryptic dispatches in scientific history.",
    ...
    keyContributions: [
      ...
      {
        title: "Chicago Pile-1 (CP-1): first self-sustaining chain reaction (2 December 1942)",
      ...
      },
      {
        ...
        detail: "Fermi made foundational contributions at Los Alamos (implosion diagnostics, Trinity test analysis). In 1950 he posed the 'Fermi Paradox': given the age and size of the galaxy, intelligent life should be detectable — where is everybody? This question continues to drive astrobiology and SETI research."
      }
    ],
    publications: [
      {
        citation: "Fermi, E. (1926). Sulla quantizzazione del gas perfetto monoatomico. Rendiconti Lincei, 3, 145–149.",
        note: "Fermi–Dirac statistics."
      },
      {
        citation: "Fermi, E. (1934). Versuch einer Theorie der β-Strahlen. Zeitschrift für Physik, 88, 161–177.",
        note: "Theory of beta decay (submitted to Nature — rejected as 'too speculative')."
      },
      {
        citation: "Fermi, E. et al. (1934). Radioactività provocata da bombardamento di neutroni. La Ricerca Scientifica, 5, 283."
      },
      {
        citation: "Fermi, E. (1947). Nuclear Physics: A Course Given by Enrico Fermi at the University of Chicago. University of Chicago Press.",
    ...
    legacy: "The Fermi unit (1 fm = 10⁻¹⁵ m, the typical size of a nucleus), Fermi level, Fermi surface, Fermi gas model, Fermilab (the US national particle accelerator laboratory), and element Fermium (Fm, Z=100) are all named in his honor. Fermi died at 53 of stomach cancer — almost certainly radiation-related from his years of neutron work without adequate protection.",
    quote: "Whatever Nature has in store for mankind, unpleasant as it may be, men must accept, for ignorance is never better than knowledge.",
  ...
  },
  {
    ...
    keyContributions: [
      ...
      {
        title: "Post-war policy work and the hydrogen bomb controversy (1945–1954)",
    ...
    publications: [
      {
        citation: "Born, M., & Oppenheimer, J.R. (1927). Zur Quantentheorie der Molekeln. Annalen der Physik, 389(20), 457–484.",
  ...
  },
  {
    ...
    education: "UC Berkeley (AB in chemistry, 1934; PhD in nuclear chemistry under Gilbert Lewis, 1937). Instructor, then Associate Professor at UC Berkeley. Worked under Arthur Compton at the Metallurgical Laboratory, Chicago (1942–1946). Chancellor, UC Berkeley (1958–1961). Chairman, US Atomic Energy Commission (1961–1971).",
    keyContributions: [
      {
      ...
      {
        title: "Co-discovery of americium (Am, Z=95) and curium (Cm, Z=96) (1944)",
      ...
      },
      {
        ...
        detail: "Seaborg's group at Berkeley subsequently co-discovered: berkelium (Bk, Z=97, 1949), californium (Cf, Z=98, 1950), einsteinium (Es, Z=99, 1952 — found in fallout from the first thermonuclear test, Ivy Mike), fermium (Fm, Z=100, 1952 — also in Ivy Mike fallout), mendelevium (Md, Z=101, 1955), nobelium (No, Z=102, 1958)."
      },
      {
        title: "AEC chairmanship and Partial Nuclear Test Ban Treaty (1961–1971)",
    ...
    publications: [
      {
        citation: "McMillan, E., & Seaborg, G.T. (1951). Nobel Prize in Chemistry Lecture: The Transuranium Elements. Nobel Foundation, Stockholm."
      },
      {
        citation: "Seaborg, G.T. (1963). Man-Made Transuranium Elements. Prentice-Hall."
      },
      {
        citation: "Seaborg, G.T., & Loveland, W.D. (1990). The Elements Beyond Uranium. Wiley."
      }
    ],
    awards: [
    ...
    legacy: "Seaborgium (Sg, Z=106) was named in his honor in 1997 — the only time an element has been officially named after a living person. Seaborg holds the Guinness record for the longest entry in Who's Who in America. The actinide series he identified is foundational to nuclear fuel cycle chemistry, reactor physics, and nuclear waste management.",
    quote: "There is an amazingly close working relationship, both in the laboratory and in policy discussions, between those who work on the weapons and those who work on peaceful applications.",
  ...
  },
  {
    ...
    education: "US Naval Academy, Annapolis (BS, 1922). University of Chicago (MS in electrical engineering, 1929). Studied nuclear technology at Oak Ridge National Laboratory (1946–1947) — the turning point in his career. Never held a PhD but is credited with creating the nuclear engineering discipline as a practical profession.",
    keyContributions: [
      {
    ...
    publications: [
      {
        citation: "Rockwell, T. (1992). The Rickover Effect: How One Man Made a Difference. Naval Institute Press.",
        note: "Definitive biography by Rickover's long-time technical director."
      },
      {
        citation: "Rickover, H.G. (1953). Naval Reactors: The Making of Nuclear Naval Power. US Government Printing Office."
      }
    ],
    awards: [
...
function FigureCard({ figure }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border rounded-lg overflow-hidden bg-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `shrink-0 ${figure.accentColor}`, children: figure.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mb-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground font-display", children: figure.name }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  ...
                  children: figure.level
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground truncate", children: figure.tagline })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 text-muted-foreground ml-2", children: open ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4" }) })
        ]
      }
    ),
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-6 pt-2 border-t border-border space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground leading-relaxed", children: figure.overview }) }),
      figure.quote && /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "border-l-4 border-primary/40 pl-4 py-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "italic text-foreground/80 text-sm leading-relaxed", children: [
          '"',
          figure.quote,
          '"'
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-1 text-xs text-muted-foreground", children: [
          "— ",
          figure.quoteSource
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-widest text-muted-foreground font-semibold mb-1", children: "Born" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed", children: figure.born })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-widest text-muted-foreground font-semibold mb-1", children: "Education & Career" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed", children: figure.education })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-widest text-muted-foreground font-semibold mb-1", children: "Awards & Honours" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: figure.awards.map((award) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                className: "flex items-start gap-2 text-sm text-foreground",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-3.5 h-3.5 mt-0.5 shrink-0 text-secondary-foreground/70" }),
                  award
                ]
              },
              award
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-widest text-muted-foreground font-semibold mb-2", children: "Key Contributions" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: figure.keyContributions.map((contrib) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "bg-muted/40 rounded-md p-3",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mb-1", children: contrib.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed whitespace-pre-line", children: contrib.detail })
              ]
            },
            contrib.title
          )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-widest text-muted-foreground font-semibold mb-2", children: "Key Publications" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: figure.publications.map((pub) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-3.5 h-3.5 mt-0.5 shrink-0 text-primary/60" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/90 leading-relaxed", children: pub.citation }),
            pub.note && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1 text-muted-foreground italic", children: [
              "— ",
              pub.note
            ] })
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-widest text-muted-foreground font-semibold mb-1", children: "Legacy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed", children: figure.legacy })
      ] })
    ] })
  ] });
}
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Key Figures" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold font-display text-foreground tracking-tight", children: "Key Figures in Nuclear Science" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose prose-sm max-w-none text-muted-foreground space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Nuclear science was shaped by a remarkable concentration of scientific genius in the first half of the 20th century. Between Becquerel's accidental 1896 discovery of radioactivity and Fermi's 1942 chain reaction, the entire theoretical and experimental foundation of nuclear physics was constructed — in less than 50 years — by a surprisingly small number of interconnected scientists working across Europe and America." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "This page profiles nine scientists whose discoveries made nuclear energy, nuclear medicine, and modern nuclear policy possible. Each profile covers their background, key contributions (with equations and primary sources), major publications, awards, and enduring legacy. Sections are collapsed by default — expand any figure to read the full profile." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 pt-1", children: [
              ["beginner", "intermediate"].map((level) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground self-center ml-1", children: "— content depth indicators" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/30 border border-border rounded-lg p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs uppercase tracking-widest text-muted-foreground font-semibold mb-3", children: "Timeline of key discoveries" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-y-1.5 gap-x-6 text-sm", children: [
          ...
          ].map(([year, event]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-mono text-xs w-16 shrink-0 pt-0.5", children: year }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/80", children: event })
          ] }, year)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "keyfigures.list", children: figures.map((figure, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `keyfigures.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FigureCard, { figure }) }, figure.id)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/20 border border-border rounded-lg p-4 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs uppercase tracking-widest font-semibold mb-2 text-foreground/60", children: "Primary sources & further reading" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-1 leading-relaxed", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              "NNDC/BNL — Evaluated Nuclear Structure Data File (ENSDF),",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs", children: "https://www.nndc.bnl.gov/ensdf/" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              "Nobel Prize Foundation — Physics and Chemistry Nobel Lectures,",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs", children: "https://www.nobelprize.org" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              "Rhodes, R. (1986). ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "The Making of the Atomic Bomb" }),
              ". Simon & Schuster. ISBN 978-0-684-81378-3."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              "Sime, R.L. (1996). ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Lise Meitner: A Life in Physics" }),
              ". University of California Press."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              "Rockwell, T. (1992). ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "The Rickover Effect" }),
              ". Naval Institute Press."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              "Seaborg, G.T., & Loveland, W.D. (1990).",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "The Elements Beyond Uranium" }),
              ". Wiley."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              "Bird, K., & Sherwin, M.J. (2005).",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "American Prometheus: The Triumph and Tragedy of J. Robert Oppenheimer" }),
              ". Knopf."
            ] })
          ] })
        ] })
