import { r as reactExports, z as Fuse, j as jsxRuntimeExports, P as PageHeader, D as Search, H as Input, J as X, B as Button, A as AudienceBadge, E as EquationBlock, k as Badge } from "./index-DTpTSWSe.js";
const glossaryTerms = [
  // ────────────────────────────────────────────────
  // PHYSICS
  // ────────────────────────────────────────────────
  ...
  // ────────────────────────────────────────────────
  {
    ...
    equation: "\\rho \\geq \\beta_{\\rm eff} \\Rightarrow \\text{prompt critical}"
  },
  {
    id: "fast-reactor",
    term: "Fast reactor",
    definition: "A reactor operating with fast (unmoderated) neutrons rather than thermal neutrons. Fast neutrons have higher fission cross-sections for Pu-239 and can breed fissile material from fertile U-238 at a breeding ratio >1. Fast reactors can also transmute long-lived minor actinides (Am, Cm, Np) into shorter-lived fission products. Examples: BN-800/BN-1200 (Russia), EBR-II (USA, retired), CFR-600 (China, under construction).",
    category: "Reactor Engineering",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  },
  {
    id: "fuel-rod",
    term: "Fuel rod",
    definition: "A slender tube of zircaloy cladding containing stacked UO₂ fuel pellets (~10 mm diameter, ~10 mm tall). Each pellet contains ~8g of UO₂ at ~95% theoretical density. A typical PWR fuel rod is ~3.7 m long, 9.5 mm OD, containing ~200 pellets. Rods are bundled into fuel assemblies. The rod-to-rod gap contains helium pressurisation (~30 bar) to aid heat transfer.",
    category: "Fuel Cycle",
    audience: "intermediate",
    audienceLevel: "intermediate",
  ...
  },
  {
    ...
    definition: "A personal dosimeter using Al₂O₃:C (aluminium oxide doped with carbon). Ionizing radiation creates trapped electron populations; laser light stimulates emission of light proportional to accumulated dose. More sensitive than TLD; re-readable; lower fading. The InLight® and Luxel® systems are widely used for occupational monitoring. Energy range: 5 keV to >40 MeV photons. Minimum detectable dose: ~1 μSv.",
    category: "Detection",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  // ────────────────────────────────────────────────
  {
    id: "stellarator",
    term: "Stellarator",
    definition: "A toroidal magnetic confinement device where all magnetic field shaping is done by complex 3D non-planar external coils — no plasma current is required. Intrinsically steady-state and disruption-free (unlike tokamaks). The complex coil geometry was historically impossible to manufacture precisely; modern CNC machining and computational optimisation have revived interest. Wendelstein 7-X (Germany) is the world's largest optimised stellarator.",
    category: "Physics",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  },
  {
    ...
    definition: "A cancer treatment in which a boron-10 compound is delivered to tumour cells, then the patient is irradiated with thermal neutrons. ¹⁰B + n → [¹¹B*] → ⁴He + ⁷Li + 2.79 MeV. The alpha particle and lithium ion travel only ~5–9 μm in tissue (single cell diameters), delivering lethal dose directly to B-10-containing tumour cells with minimal effect on adjacent healthy tissue. FDA-approved for head/neck cancers (boronophenylalanine-F, 2023 in Japan).",
    category: "Applications",
    audience: "advanced",
    audienceLevel: "advanced",
    relatedTerms: [
  ...
  },
  {
    ...
    definition: "A theoretical climate effect following large-scale nuclear conflict in which soot and smoke from nuclear-ignited fires would be lofted into the stratosphere, blocking sunlight and causing global temperature drops of 15–30°C for months to years. First analysed by Turco et al. (TTAPS, 1983) and Sagan & Turco (1990). Modern climate modelling (Robock et al., 2007) suggests even a regional nuclear exchange (100 warheads) could cause global cooling of ~1°C lasting a decade. Widely regarded as a major deterrence consideration.",
    category: "History",
    audience: "beginner",
    audienceLevel: "beginner",
  ...
  },
  {
    id: "barn",
    term: "Barn",
    definition: "A unit of nuclear cross-section area used to quantify the probability of a nuclear reaction. 1 barn = 10⁻²⁸ m² = 10⁻²⁴ cm². The name is jocular: physicists working on the Manhattan Project found uranium nuclei were 'as big as a barn' compared to what they expected. Thermal-neutron fission cross-section of ²³⁵U = 585 barns.",
    category: "Physics",
    audience: "intermediate",
    audienceLevel: "intermediate",
  ...
  },
  {
    id: "lawson-criterion",
    term: "Lawson criterion",
    definition: "A condition for net energy gain from nuclear fusion: the product of plasma density n and energy confinement time τ_E must exceed ~10²⁰ m⁻³·s for a D-T plasma at ~10 keV. Derived by John Lawson in 1957. Modern formulations use the 'triple product' nτ_E T ≥ 3 × 10²¹ m⁻³·s·keV. The NIF 2022 ignition exceeded the Lawson criterion for inertial confinement.",
    category: "Physics",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  },
  {
    ...
    definition: "A formula describing the energy-dependent cross-section near a nuclear resonance: σ(E) = σ₀ [Γ²/4] / [(E − E₀)² + Γ²/4]. E₀ is the resonance energy, Γ is the total width (sum of partial widths Γ_n + Γ_γ + …), and σ₀ is the peak cross-section. Describes U-238's capture resonances (4–4000 eV) that are critical for reactor design.",
    category: "Physics",
    audience: "professional",
    audienceLevel: "professional",
    relatedTerms: [
    ...
    equation: "\\sigma(E) = \\sigma_0 \\frac{\\Gamma^2/4}{(E-E_0)^2+\\Gamma^2/4}"
  },
  {
    id: "geiger-nuttall-law",
    term: "Geiger-Nuttall law",
    definition: "An empirical relationship between the alpha-decay half-life and the kinetic energy of the emitted alpha particle: log(T½) ∝ Z / √E_α. Established by Geiger and Nuttall in 1911 and later derived quantum mechanically via the Gamow tunnelling factor. Explains why alpha emitters with higher Q-values have shorter half-lives — spanning 19 orders of magnitude.",
    category: "Isotopes & Decay",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  },
  {
    ...
    equation: "G = \\exp\\!\\left(-2\\pi\\eta\\right), \\quad \\eta = \\frac{Z_1 Z_2 e^2}{\\hbar v}"
  },
  {
    id: "auger-electron",
    term: "Auger electron",
  ...
  },
  {
    ...
    definition: "Electromagnetic radiation emitted when a charged particle travels through a medium at a speed greater than the phase velocity of light in that medium (v > c/n). The threshold condition is β = v/c ≥ 1/n. In water (n ≈ 1.33), electrons above ~0.26 MeV produce the characteristic blue glow seen in reactor pools. Čerenkov detectors are used in neutrino experiments and medical PET devices.",
    category: "Detection",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  },
  {
    id: "fermi-age",
    term: "Fermi age",
    definition: "A measure of the spatial displacement of neutrons as they slow down from fast to thermal energies in a moderating medium. τ = D/Σ_s · (integral over lethargy), with units of cm². In water: τ ≈ 27 cm²; in graphite: τ ≈ 368 cm². Used in Fermi age theory to describe neutron slowing-down before thermalisation.",
    category: "Reactor Engineering",
    audience: "professional",
    audienceLevel: "professional",
    relatedTerms: ["moderator", "thermal-neutron", "diffusion-length"],
    equation: "\\tau = \\frac{D}{\\Sigma_s}\\int \\frac{du}{\\xi\\Sigma_s} \\quad [\\text{cm}^2]"
  },
  {
    id: "isomeric-transition",
    term: "Isomeric transition (IT)",
    definition: "Radioactive decay of a nuclear isomer (metastable excited state) to the ground state by emission of a gamma photon or conversion electron. The most important example is ⁹⁹ᵐTc → ⁹⁹Tc + γ (140.5 keV), T½ = 6.01 h — the workhorse of nuclear medicine. Isomeric transitions preserve the element (same Z and A) but change the nuclear energy state.",
    category: "Isotopes & Decay",
    audience: "intermediate",
    audienceLevel: "intermediate",
    relatedTerms: [
  ...
  },
  {
    id: "kerma",
    term: "Kerma",
    definition: "Kinetic Energy Released per unit MAss in a medium by uncharged ionising particles (photons or neutrons). K = ΣE_tr / m, expressed in J/kg (gray). Kerma is equal to absorbed dose D in conditions of charged-particle equilibrium (CPE). For photons: K = Φ · E · μ_tr/ρ. Important for dosimetry in radiation therapy and nuclear reactor environments.",
    category: "Radiation & Biology",
    audience: "advanced",
    audienceLevel: "advanced",
    relatedTerms: ["absorbed-dose", "fluence", "mass-attenuation-coefficient"],
    equation: "K = \\Phi \\cdot E \\cdot (\\mu_{\\rm tr}/\\rho) \\quad [\\text{Gy}]"
  },
  {
    id: "lethargy",
    term: "Lethargy",
    definition: "A logarithmic energy variable used in neutron transport theory: u = ln(E₀/E), where E₀ is a reference energy (typically 10 MeV). Lethargy increases as neutrons slow down; per-collision lethargy increase ξ = 1 + [(A−1)²/2A] ln[(A−1)/(A+1)] is constant for elastic scattering. Average number of collisions to thermalise: n = (u_thermal) / ξ ≈ 18 (H₂O), 114 (graphite).",
    category: "Reactor Engineering",
    audience: "professional",
    audienceLevel: "professional",
  ...
  },
  {
    id: "migration-area",
    term: "Migration area",
    definition: "The sum of the slowing-down area (Fermi age τ) and the thermal diffusion area L²: M² = τ + L². Characterises the total spatial spread of neutrons from fast to thermal, and from thermal to absorption. In water: M² ≈ 27 + 8 = 35 cm². Used in reactor criticality calculations as the 'migration length' M ≈ 6 cm.",
    category: "Reactor Engineering",
    audience: "professional",
    audienceLevel: "professional",
  ...
  },
  {
    ...
    definition: "A state reached in a decay chain when a parent nuclide has a much longer half-life than its daughters. After several daughter half-lives, each daughter decays as fast as it is produced: λ₁N₁ = λ₂N₂ = λ₃N₃. Applies when T½(parent) >> T½(daughter). Example: ²²⁶Ra (1600 y) → ²²²Rn (3.8 d): Rn activity = Ra activity in an undisturbed source.",
    category: "Isotopes & Decay",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  },
  {
    ...
    definition: "The radioactivity per unit mass of a radionuclide: A_sp = λ N_A / M = ln2 · N_A / (T½ · M), in Bq/g. For ²²⁶Ra: A_sp = 3.7 × 10¹⁰ Bq/g (the original definition of 1 curie). For ¹³¹I (T½=8 d): A_sp ≈ 4.6 × 10¹⁵ Bq/g. High specific activity is required for radiolabelled pharmaceuticals to minimise administered mass.",
    category: "Isotopes & Decay",
    audience: "intermediate",
    audienceLevel: "intermediate",
    relatedTerms: ["radioactivity", "half-life", "becquerel", "curie"],
    equation: "A_{\\rm sp} = \\frac{\\lambda N_A}{M} = \\frac{\\ln 2 \\cdot N_A}{T_{1/2} \\cdot M}"
  },
  {
    id: "transmutation",
    term: "Transmutation",
    definition: "The conversion of one nuclide into another by nuclear reaction (neutron capture, fission, or spallation). In the context of nuclear waste management, transmutation of long-lived actinides (²³⁹Pu, ²⁴¹Am) into shorter-lived fission products in fast reactors or accelerator-driven systems (ADS) can dramatically reduce repository timescales. The concept dates to alchemists' dream of converting lead to gold.",
    category: "Fuel Cycle",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  },
  {
    id: "photofission",
    term: "Photofission",
    definition: "Nuclear fission induced by a high-energy photon (gamma ray) rather than a neutron. Threshold for ²³⁸U: ~5.1 MeV; for ²³⁵U: ~5.3 MeV. Photofission is used in nuclear security (cargo scanning, warhead authentication) and was first observed by Haxby et al. in 1941. Cross-sections are generally 1–100 mb near threshold.",
    category: "Physics",
    audience: "professional",
    audienceLevel: "professional",
  ...
  // ────────────────────────────────────────────────
  {
    ...
    definition: "Electrons fill atomic orbitals in order of increasing energy, as given by the Madelung (n+l) rule: fill 1s, 2s, 2p, 3s, 3p, 4s, 3d, 4p... The principle (German: 'building up') determines ground-state electron configurations. Exceptions arise for Cr (d⁵ half-shell stability) and Cu (d¹⁰ full-shell stability).",
  ...
  },
  {
    id: "boson",
    term: "Boson",
    definition: "A particle with integer spin (s = 0, 1, 2, …) that obeys Bose-Einstein statistics. Force-carrying gauge bosons include photons (γ), W±, Z⁰, gluons (g), and the graviton (hypothetical). The Higgs boson (H⁰, mass 125.25 GeV/c²) was discovered at CERN in 2012. Composite bosons include alpha particles (²⁴He, spin-0) and many atomic nuclei with even-mass number.",
  ...
  },
  {
    ...
    definition: "Operators that raise (â†) or lower (â) the quantum number of an eigenstate: â†|n⟩ = √(n+1)|n+1⟩ and â|n⟩ = √n|n−1⟩. Used to solve the quantum harmonic oscillator algebraically, derive angular momentum eigenstates (J±), and construct field operators in quantum field theory. The number operator N̂ = â†â has eigenvalues n = 0, 1, 2, …",
    category: "Quantum Mechanics",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  },
  {
    ...
    definition: "A quantum system with a parabolic potential V = ½mω²x². Energy eigenvalues: E_n = ℏω(n + ½), n = 0, 1, 2, … The zero-point energy E₀ = ℏω/2 is irreducible due to Heisenberg uncertainty. The QHO is exactly solvable and serves as the basis for vibrational modes in molecules, phonons in solids, and quantized electromagnetic field modes (photons).",
    category: "Quantum Mechanics",
    audience: "advanced",
    audienceLevel: "advanced",
    relatedTerms: [
  ...
  },
  {
    ...
    definition: "The first complete formulation of quantum mechanics, developed by Heisenberg, Born, and Jordan in 1925. Physical observables are represented as infinite matrices; their multiplication is non-commutative, embodying the uncertainty principle. Schrödinger's wave mechanics (1926) was later shown to be mathematically equivalent. Dirac unified both into transformation theory.",
    category: "Quantum Mechanics",
    audience: "advanced",
    audienceLevel: "advanced",
    relatedTerms: [
  ...
  },
  {
    ...
    definition: "A mathematical operation on a wave function that corresponds to a physical observable. In quantum mechanics: position x̂ = x (multiplication); momentum p̂ = −iℏ∂/∂x; energy Ê = iℏ∂/∂t; angular momentum L̂_z = −iℏ∂/∂φ. Hermitian operators have real eigenvalues (physically measurable). The expectation value ⟨O⟩ = ⟨ψ|Ô|ψ⟩.",
    category: "Quantum Mechanics",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  },
  {
    ...
    definition: "No two identical fermions can occupy the same quantum state simultaneously (same n, l, m_l, m_s). Formulated by Wolfgang Pauli in 1925. Explains the periodic table structure, prevents electron shells from collapsing, and is responsible for the stability of matter, chemical bonding, and the degeneracy pressure in white dwarfs and neutron stars.",
    category: "Quantum Mechanics",
    audience: "intermediate",
    audienceLevel: "intermediate",
  ...
  },
  {
    ...
    definition: "The squared modulus of the wave function |ψ(r,t)|² gives the probability per unit volume of finding the particle at position r at time t. The Born rule: P(r,t) = |ψ|² with ∫|ψ|² dV = 1 (normalisation). For hydrogen 1s: |ψ₁s|² ∝ exp(−2r/a₀), peaking at r = 0 but with most probability at the Bohr radius a₀ = 0.529 Å.",
    category: "Quantum Mechanics",
    audience: "intermediate",
    audienceLevel: "intermediate",
  ...
  },
  {
    ...
    equation: "E_{\\rm trial} = \\langle\\psi_{\\rm trial}|\\hat{H}|\\psi_{\\rm trial}\\rangle \\geq E_0"
  },
  {
    id: "zero-point-energy",
    term: "Zero-point energy",
    definition: "The minimum energy of a quantum system at absolute zero (T = 0 K), arising from Heisenberg uncertainty: a confined particle cannot have zero momentum simultaneously. For a quantum harmonic oscillator: E₀ = ℏω/2. For a hydrogen atom: E₀ = −13.6 eV. Zero-point motion contributes to van der Waals forces and prevents helium from solidifying at ambient pressure without applied pressure.",
    category: "Quantum Mechanics",
    audience: "intermediate",
    audienceLevel: "intermediate",
    relatedTerms: [
  ...
  },
  {
    ...
    definition: "The precession of a magnetic dipole moment in an external magnetic field B at the Larmor frequency ω_L = γB, where γ is the gyromagnetic ratio. For a proton: γ_p = 2.675 × 10⁸ rad·s⁻¹·T⁻¹, giving 42.6 MHz/T in NMR/MRI. The nuclear Larmor precession is exploited in NMR spectroscopy, MRI, and precision measurements of nuclear magnetic moments.",
    category: "Quantum Mechanics",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  },
  {
    ...
    definition: "The radial part R_nl(r) of the hydrogen wave function ψ_nlm = R_nl(r) Y_l^m(θ,φ). Depends on principal quantum number n and orbital quantum number l. For the 1s orbital: R_10 = 2(1/a₀)^(3/2) exp(−r/a₀). Radial probability density: P(r) = r²|R_nl(r)|². The most probable radius for 1s is the Bohr radius a₀ = 0.529 Å.",
    category: "Quantum Mechanics",
    audience: "advanced",
    audienceLevel: "advanced",
    relatedTerms: [
  ...
  },
  {
    id: "gauge-boson",
    term: "Gauge boson",
    definition: "Force-carrying particles that mediate the fundamental interactions: photon (γ, electromagnetic), W± and Z⁰ (weak), gluons (g, strong), graviton (gravity, not yet detected). All are spin-1 (vector) bosons except the spin-2 graviton. In gauge theories, bosons arise from local symmetry requirements — U(1) for QED, SU(2) for weak, SU(3) for QCD.",
    category: "Particle Physics",
    audience: "intermediate",
    audienceLevel: "intermediate",
  ...
  },
  {
    id: "hadron",
    term: "Hadron",
    definition: "A composite particle made of quarks bound by the strong force. Baryons (e.g., proton, neutron) contain three quarks (qqq); mesons (e.g., pion, kaon) contain a quark-antiquark pair (qq̄). Exotic hadrons include tetraquarks (qq̄q'q̄') and pentaquarks (qqqqq̄) — observed at LHCb. Hadrons are the particles that participate in the nuclear force; leptons do not.",
    category: "Particle Physics",
    audience: "intermediate",
    audienceLevel: "intermediate",
  ...
  },
  {
    ...
    definition: "The spontaneous symmetry-breaking mechanism by which the W± and Z⁰ bosons acquire mass while the photon remains massless. The Higgs field φ has a non-zero vacuum expectation value ⟨φ⟩ = v/√2 ≈ 174 GeV. Interaction with this field gives fermions and gauge bosons their masses: m_W = gv/2 ≈ 80.4 GeV/c². The associated quantum is the Higgs boson (H⁰), discovered at CERN in 2012 with mass 125.25 GeV/c².",
    category: "Particle Physics",
    audience: "advanced",
    audienceLevel: "advanced",
    relatedTerms: [
  ...
  },
  {
    id: "lepton-number",
    term: "Lepton number",
    definition: "A conserved quantum number: L = +1 for leptons (e⁻, μ⁻, τ⁻, ν_e, ν_μ, ν_τ); L = −1 for antileptons; L = 0 for quarks and bosons. Separate lepton family numbers L_e, L_μ, L_τ are approximately conserved (violated only slightly by neutrino oscillations). Beta decay: n → p + e⁻ + ν̄_e conserves L_e = 0 (electron: +1, antineutrino: −1).",
    category: "Particle Physics",
    audience: "advanced",
    audienceLevel: "advanced",
  ...
  },
  {
    id: "quark",
    term: "Quark",
    definition: "A fundamental constituent of matter, carrying fractional electric charge (±⅓e or ±⅔e) and color charge. Six flavours: up (u, +⅔e), down (d, −⅓e), strange (s, −⅓e), charm (c, +⅔e), bottom (b, −⅓e), top (t, +⅔e, mass 172.7 GeV/c²). Proton = uud; neutron = udd. Quarks are never observed in isolation (confinement); top quark discovered at Fermilab in 1995.",
    category: "Particle Physics",
    audience: "intermediate",
    audienceLevel: "intermediate",
    relatedTerms: [
  ...
  },
  {
    id: "w-boson",
    term: "W boson",
    definition: "Charged gauge bosons (W⁺ and W⁻) that mediate the weak nuclear force responsible for beta decay and nuclear reactions in stars. Discovered at CERN by Carlo Rubbia and Simon van der Meer in 1983 (Nobel Prize 1984). Mass M_W = 80.377 ± 0.012 GeV/c² (PDG 2022). In beta-minus decay: n → p + e⁻ + ν̄_e proceeds via d → u + W⁻.",
    category: "Particle Physics",
    audience: "advanced",
    audienceLevel: "advanced",
    relatedTerms: [
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            term.equation && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              EquationBlock,
              {
                latex: term.equation,
                display: false,
