    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionCard, { "data-ocid": "cross_sections.overview_card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "\\sigma" }),
          " is an",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "effective area" }),
          " that quantifies the probability of a specific nuclear interaction. It is not literally a geometric area — quantum effects mean ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "\\sigma" }),
          " can be orders of magnitude larger or smaller than the actual nuclear size."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-accent/10 border border-accent/20 p-4 mb-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed", children: [
            ...
            ":",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "1\\,\\text{b} = 10^{-24}\\,\\text{cm}^2 = 10^{-28}\\,\\text{m}^2" }),
            ". The unit was coined during the Manhattan Project. The actual nuclear geometric area is",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "\\sim 10^{-30}\\,\\text{m}^2" }),
            "(nuclear radius 1–8 fm), yet thermal neutron fission cross-sections for ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(NuclearNotation, { symbol: "U", A: 235, Z: 92 }),
            " ",
            "reach 584 barns — roughly",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "500× the geometric area" }),
            "."
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          EquationBlock,
          {
            ...
            label: "Cross-Section Definition \\u03c3 = R / n\\u03a6"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          EquationBlock,
          {
            latex: "R = N \\, \\sigma \\, \\Phi",
            annotation: "Reaction rate R [reactions/cm\\u00b3/s]: N = atom density [atoms/cm\\u00b3], \\u03c3 = microscopic cross-section [cm\\u00b2], \\u03a6 = neutron flux [n/cm\\u00b2/s]. Macroscopic cross-section \\u03a3 = N\\u03c3 [cm\\u207b\\u00b9].",
            label: "Reaction Rate R = N\\u03c3\\u03a6"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          EquationBlock,
          {
            ...
            annotation: "Mean free path \\u03bb_mfp [cm]: average distance a neutron travels between interactions. \\u03a3 = N\\u03c3 is the macroscopic cross-section [cm\\u207b\\u00b9]. Source: Lamarsh & Baratta, Introduction to Nuclear Engineering.",
