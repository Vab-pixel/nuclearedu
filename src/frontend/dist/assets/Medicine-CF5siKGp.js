import { j as jsxRuntimeExports, P as PageHeader, S as SectionCard, c as SafetyCallout, r as reactExports, a as AudienceBadge, b as ChevronDown, C as ChevronRight } from "./index-Dw4QPaCL.js";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: "¹⁸F: The Dominant PET Radionuclide" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: "F-18 has emerged as the dominant PET radionuclide due to a unique combination of favourable properties. Production via ¹⁸O(p,n)¹⁸F at 16–18 MeV proton energies in medical cyclotrons yields 50–150 GBq per 30-minute bombardment from H₂¹⁸O targets." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DataTable,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: "⁶⁸Ga: Generator-Based PET Without a Cyclotron" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: "⁶⁸Ga (T½ = 67.7 min) has transformed PET access at hospitals without on-site cyclotrons. The ⁶⁸Ge/⁶⁸Ga generator (⁶⁸Ge T½ = 270.95 days; daughter ⁶⁸Ga by electron capture) provides reliable daily supply for 1–2 years per generator, enabling PSMA and DOTATATE PET programs at institutions globally. ⁶⁸Ga chelates readily with DOTA-peptide conjugates (DOTATATE, DOTATOC, PSMA-11) via rapid kit-based chemistry at room temperature." }),
