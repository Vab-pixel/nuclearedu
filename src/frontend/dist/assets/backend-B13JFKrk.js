...
import { bM as slebEncode, bN as safeReadUint8, bO as iexp2, bP as writeIntLE, bQ as readIntLE, bR as writeUIntLE, bS as readUIntLE, bT as safeRead, bU as uint8ToDataView, bV as lebEncode, bW as concat, bX as lebDecode, bY as slebDecode, bZ as PipeArrayBuffer, b_ as Principal$1, b$ as InputError, c0 as CborEncodeErrorCode, c1 as CborDecodeErrorCode, c2 as ExpiryJsonDeserializeErrorCode, c3 as utf8ToBytes, c4 as _validateObject, c5 as isHash, c6 as abytes, c7 as mod, c8 as concatBytes, c9 as bytesToNumberBE, ca as isBytes, cb as FpInvertBatch, cc as Field, cd as _createCurveFields, ce as wNAF, cf as ensureBytes, cg as _abool2, ch as _abytes2, ci as normalizeZ, cj as mulEndoUnsafe, ck as bytesToHex, cl as pippenger, cm as inRange, cn as memoized, co as negateCt, cp as bitMask, cq as bitLen, cr as validateField, cs as getMinHashLength, ct as mapHashToField, cu as randomBytes, cv as FpPow, cw as FpLegendre, cx as notImplemented, cy as bitGet, cz as sha256, cA as numberToBytesBE, cB as UNREACHABLE_ERROR, cC as UnknownError, cD as HashTreeDecodeErrorCode, cE as uint8Equals, cF as ProtocolError, cG as CertificateVerificationErrorCode, cH as TrustError, cI as CertificateTimeErrorCode, cJ as UnexpectedErrorCode, cK as CertificateHasTooManyDelegationsErrorCode, cL as CertificateNotAuthorizedErrorCode, cM as MissingLookupValueErrorCode, cN as DerKeyLengthMismatchErrorCode, cO as DerPrefixMismatchErrorCode, cP as LookupErrorCode, cQ as MalformedLookupFoundValueErrorCode, cR as hexToBytes, cS as ExternalError, cT as MissingRootKeyErrorCode, cU as AgentError, cV as wrapDER, cW as unwrapDER, cX as DerDecodeErrorCode, cY as ED25519_OID, cZ as hashOfMap, c_ as MalformedPublicKeyErrorCode, c$ as ed25519, d0 as QuerySignatureVerificationFailedErrorCode, d1 as AnonymousIdentity, d2 as IngressExpiryInvalidErrorCode, d3 as CreateHttpAgentErrorCode, d4 as IdentityInvalidErrorCode, d5 as requestIdOf, d6 as HttpV3ApiNotSupportedErrorCode, d7 as TimeoutWaitingForResponseErrorCode, d8 as uint8FromBufLike, d9 as HttpErrorCode, da as TransportError, db as HttpFetchErrorCode, dc as MalformedSignatureErrorCode, dd as CertificateOutdatedErrorCode, de as MissingSignatureErrorCode, df as IC_RESPONSE_DOMAIN_SEPARATOR, dg as HttpDefaultFetchErrorCode, dh as RequestStatusDoneNoReplyErrorCode, di as RejectError, dj as CertifiedRejectErrorCode, dk as InvalidReadStateRequestErrorCode, dl as MissingCanisterIdErrorCode, dm as UncertifiedRejectErrorCode, dn as UncertifiedRejectUpdateErrorCode } from "./index-DWzjlv-D.js";
...
const IsotopeRecord = Record({
  "n": Nat,
  "z": Nat,
  "branchingRatios": Vec(Float64),
  "decayModes": Vec(Text),
  "name": Text,
  "lastUpdated": Text,
  "sourceUri": Text,
  "atomicMassAMU": Float64,
  "massExcessKeV": Float64,
  "bindingEnergyPerNucleon": Float64,
  "abundance": Float64,
  "halfLifeSeconds": Float64,
  "qValueMeV": Float64,
  "symbol": Text
});
const IsotopePageResult = Record({
...
const Result = Variant({ "ok": IsotopeRecord, "err": Text });
Service({
  "fetchAllIsotopesPage": Func([Nat, Nat], [Result_1], []),
  "fetchIsotopeData": Func([Nat, Nat], [Result], []),
  "getCachedIsotopeCount": Func([], [Nat], ["query"]),
  "getLastFetchTimestamp": Func([], [Int], ["query"])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const IsotopeRecord2 = IDL2.Record({
    "n": IDL2.Nat,
    "z": IDL2.Nat,
    "branchingRatios": IDL2.Vec(IDL2.Float64),
    "decayModes": IDL2.Vec(IDL2.Text),
    "name": IDL2.Text,
    "lastUpdated": IDL2.Text,
    "sourceUri": IDL2.Text,
    "atomicMassAMU": IDL2.Float64,
    "massExcessKeV": IDL2.Float64,
    "bindingEnergyPerNucleon": IDL2.Float64,
    "abundance": IDL2.Float64,
    "halfLifeSeconds": IDL2.Float64,
    "qValueMeV": IDL2.Float64,
    "symbol": IDL2.Text
  });
  const IsotopePageResult2 = IDL2.Record({
    "records": IDL2.Vec(IsotopeRecord2),
    "page": IDL2.Nat,
    "totalCount": IDL2.Nat,
    "pageSize": IDL2.Nat
  });
  const Result_12 = IDL2.Variant({ "ok": IsotopePageResult2, "err": IDL2.Text });
  const Result2 = IDL2.Variant({ "ok": IsotopeRecord2, "err": IDL2.Text });
  return IDL2.Service({
    "fetchAllIsotopesPage": IDL2.Func([IDL2.Nat, IDL2.Nat], [Result_12], []),
    "fetchIsotopeData": IDL2.Func([IDL2.Nat, IDL2.Nat], [Result2], []),
    "getCachedIsotopeCount": IDL2.Func([], [IDL2.Nat], ["query"]),
    "getLastFetchTimestamp": IDL2.Func([], [IDL2.Int], ["query"])
  });
};
class ExternalBlob {
...
class Backend {
  ...
  async fetchAllIsotopesPage(arg0, arg1) {
  ...
  async fetchIsotopeData(arg0, arg1) {
    if (this.processError) {
      try {
