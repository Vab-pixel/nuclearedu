import { r as reactExports, j as jsxRuntimeExports, P as PageHeader, S as SectionCard, E as EquationBlock, B as Button, f as Link, h as ChevronDown, g as ChevronRight } from "./index-DWzjlv-D.js";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-muted/20 p-5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-3", children: [
                  ...
                  " by an inner-shell (K or L) bound electron. The electron is ejected with kinetic energy ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "T = E_\\gamma - B_e" }),
                  ", where",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "B_e" }),
                  " is the electron binding energy. The resulting vacancy is filled by outer-shell electrons, emitting characteristic X-rays (fluorescence) or Auger electrons. The cross-section scales as",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "\\sigma_{PE} \\propto Z^{4.5} / E_\\gamma^{3.5}" }),
                  "."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-sm text-muted-foreground space-y-1 list-none", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-muted/20 p-5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-3", children: [
                  "In the Coulomb field of a nucleus, a photon spontaneously converts into an electron-positron (",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "e^-e^+" }),
                  ") pair. This is a direct manifestation of ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "E = mc^2" }),
                  ". The threshold energy is exactly:",
                  ...
                  "The positron rapidly slows, annihilates with an ambient electron, and emits two collinear 511 keV photons — the signature exploited in PET imaging."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-sm text-muted-foreground space-y-1 list-none", children: [
