import { d as React, $ as filterProps, a0 as clsx, a1 as polarToCartesian, a2 as getDefaultExportFromCjs, a3 as isFunction, a4 as Dot, a5 as Layer, a6 as Animate, a7 as interpolateNumber, a8 as isEqual, v as LabelList, r as reactExports, a9 as Global, aa as getValueByDataKey, ab as last, ac as isNil, ad as generateCategoricalChart, ae as formatAxisMap, j as jsxRuntimeExports, P as PageHeader, af as Check, J as X, m as motion, S as SectionCard, R as ResponsiveContainer, ag as Legend, T as Tooltip, E as EquationBlock, z as Fuse, c as AnimatePresence } from "./index-DWzjlv-D.js";
...
import { P as Polygon, a as PolarAngleAxis, b as PolarRadiusAxis } from "./PolarAngleAxis--Jf2w5W0.js";
...
function IsotopeComparison() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionCard, { "data-ocid": "isotope_comparison.physics_reference.section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-semibold text-foreground mb-1", children: "Physics Reference Equations" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-4", children: "Key formulae relevant to the properties compared above. Sources: AME2020 (Wang et al. 2021), NNDC/BNL, ICRP." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        EquationBlock,
        {
