import { w as createLucideIcon, ap as useAppStore, r as reactExports, z as Fuse, j as jsxRuntimeExports, P as PageHeader, aq as Newspaper, e as Atom, W as Funnel, D as Search, J as X, q as cn, c as AnimatePresence, m as motion, N as ExternalLink } from "./index-DWzjlv-D.js";
import { C as Calendar } from "./calendar-ClYPyZ9q.js";
/**
...
const newsItems = [
  ...
  // ── ADDITIONAL 2024 ITEMS ────────────────────────────────────────────────────
  {
    ...
    title: "Microsoft–Constellation Deal Revives Three Mile Island Unit 1 for AI Data Centers",
    summary: "Microsoft's landmark 20-year PPA with Constellation Energy to purchase all output from the restarted Three Mile Island Unit 1 (renamed Crane Clean Energy Center) exemplifies how AI and cloud computing companies are turning to nuclear power to meet soaring electricity demands. The plant is expected to restart in 2028, supplying 835 MWe of carbon-free electricity. Analysts view the deal as a signal that corporate energy buyers are increasingly willing to pay a premium for reliable, dispatchable zero-carbon power.",
    date: "2024-09",
    category: "policy",
    source: "Constellation Energy / Microsoft",
    url: "https://www.constellationenergy.com/newsroom/2023/constellation-to-launch-crane-clean-energy-center.html",
  ...
  },
  {
    ...
    summary: "Helion Energy, the US fusion startup backed by Sam Altman and OpenAI, announced in early 2024 that its seventh prototype, Polaris, has sustained plasma at 100 million°C — the temperature needed for fusion reactions — and is on track for its 2024 demonstration target. Helion uses field-reversed configuration (FRC) and pulsed operation, a distinct approach from tokamaks. Microsoft has signed a PPA for Helion's power by 2028, representing the world's first commercial fusion electricity contract.",
    date: "2024-04",
    category: "fusion",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.article,
    {
      ...
      children: [
        ...
        item.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: item.tags.slice(0, 4).map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
...
function NuclearNewsFeed() {
  ...
  const hasActiveFilters = search !== "" || activeCategory !== "all" || audienceFilter !== "all";
      ...
      "section",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: "2022–2024" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Atom, { className: "h-4 w-4 text-secondary", "aria-hidden": "true" }),
