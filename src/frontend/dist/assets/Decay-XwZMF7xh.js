import { j as jsxRuntimeExports, P as PageHeader, S as SectionCard, E as EquationBlock, B as Button, f as Link, r as reactExports, h as ChevronDown, g as ChevronRight } from "./index-DTpTSWSe.js";
import { u as u238DecayChain } from "./decayChain-D5_xRgat.js";
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-lg border border-border mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: [
                ...
                const [mode, sym, dz, dn, ex, q] = row;
                const modeKey = String(mode).replace(/\s+/g, "-").slice(0, 20);
