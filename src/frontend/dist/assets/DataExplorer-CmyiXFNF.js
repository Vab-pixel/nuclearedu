const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/backend-NkApXtC8.js","assets/index-Dw4QPaCL.js","assets/index-CowhmCIT.css"])))=>i.map(i=>d[i]);
import { g as createLucideIcon, H as create, J as persist, R as React, r as reactExports, K as ReactDOM, _ as __vitePreload, j as jsxRuntimeExports, P as PageHeader, S as SectionCard, v as X, k as ResponsiveContainer, l as BarChart, X as XAxis, Y as YAxis, n as Tooltip, o as Bar, p as Cell, Z as Zap, N as AnimatePresence, m as motion, b as ChevronDown, u as Search, O as Funnel, L as Link, E as ExternalLink } from "./index-Dw4QPaCL.js";
...
import { R as RefreshCw } from "./refresh-cw-BRmov6w_.js";
/**
...
async function fetchAllPages() {
  const backendModule = await __vitePreload(() => import("./backend-NkApXtC8.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
...
function daysSince(isoString) {
  return Math.floor(
    (Date.now() - new Date(isoString).getTime()) / (1e3 * 60 * 60 * 24)
  );
}
function FreshnessDot({ lastUpdated }) {
  if (!lastUpdated) return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/40", children: "·" });
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "hidden md:flex items-center gap-3 text-xs text-muted-foreground ml-2 border-l border-border pl-3", children: [
...
function NuclideDetail({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border px-5 py-4 bg-muted/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 border border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg font-bold text-primary", children: nuclide.symbol.replace(/\d/g, "") }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-5 space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xl font-bold text-primary", children: value })
              ]
            },
            label
          )) }),
          ...
          nuclide.branchingRatios && nuclide.branchingRatios.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: nuclide.branchingRatios.map((ratio) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
          ...
          nuclide.lastUpdated && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FreshnessDot, { lastUpdated: nuclide.lastUpdated }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { title: formatAbsoluteUTC(nuclide.lastUpdated), children: [
              "NNDC updated:",
              " ",
...
function FilterPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SectionCard, { className: "mb-4", "data-ocid": "data-explorer.filter_panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-5 items-start", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("fieldset", { className: "flex flex-wrap gap-2 border-0 p-0 m-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("legend", { className: "text-xs text-muted-foreground font-semibold uppercase tracking-widest w-full mb-1.5 flex items-center gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          type: "button",
          onClick: () => onFiltersChange({ ...filters, decayModes: /* @__PURE__ */ new Set() }),
      ...
      ALL_DECAY_MODES.map((mode) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: () => toggle(mode),
            "aria-pressed": active,
            className: `rounded-full px-3 py-1 text-xs font-semibold border transition-colors uppercase ${active ? `${DECAY_COLORS[mode]} border-transparent` : "border-border text-muted-foreground hover:border-primary/30"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-48 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground font-semibold uppercase tracking-widest mb-1.5", children: [
        "Z range:",
        " ",
...
function DataExplorer() {
  ...
  const filtered = reactExports.useMemo(() => {
    let base = filters.query.trim() ? fuseInstance.search(filters.query).map((r) => r.item) : [...nuclides];
    if (filters.decayModes.size > 0) {
      base = base.filter(
        (n) => [...filters.decayModes].every((m) => n.decayModes.includes(m)) || [...filters.decayModes].some((m) => n.decayModes.includes(m))
      );
      base = [...nuclides].filter((n) => {
        if (filters.query.trim()) {
          const fuseResults = fuseInstance.search(filters.query).map((r) => r.item);
  ...
  const handleFiltersChange = reactExports.useCallback((f) => {
    setFilters(f);
    setPage(1);
  }, []);
  ...
  const handleExport = () => {
    const header = "Symbol,Name,Z,N,A,HalfLife,DecayModes,BindingEnergy_MeV,Abundance,AtomicMass_AMU,MassExcess_keV,QValue_MeV,LastUpdated\n";
  ...
  const isFiltered = filters.query.trim() !== "" || filters.decayModes.size > 0 || filters.zMin > 0 || filters.zMax < Z_MAX || filters.aMin > 0 || filters.aMax < A_MAX;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionCard, { className: "mb-6", "data-ocid": "data-explorer.histogram.card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs uppercase tracking-widest text-muted-foreground font-semibold", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 110, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        BarChart,
        {
          data: histData,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FilterPanel, { filters, onFiltersChange: handleFiltersChange }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
        ...
        " ",
        "nuclides",
        isFiltered && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: " matching filters" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
        ...
        children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/40 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "th",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: "Freshness" })
                    }
                  ),
                  [
                    ["Symbol", "symbol"],
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: paginated.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-8 w-8 text-muted-foreground/30" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No nuclides match your filters." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                  ...
                  "tr",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FreshnessDot, { lastUpdated: n.lastUpdated }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 font-mono font-bold text-primary", children: n.symbol }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 text-foreground max-w-[140px] truncate", children: n.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 tabular-nums text-right pr-4", children: n.Z }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 tabular-nums text-right pr-4", children: n.N }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 tabular-nums text-right pr-4 font-semibold", children: n.A }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 text-muted-foreground whitespace-nowrap", children: n.halfLifeStr }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: n.decayModes.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(DecayBadge, { mode: m }, m)) }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 tabular-nums text-right pr-4", children: n.bindingEnergyPerNucleon_MeV != null ? n.bindingEnergyPerNucleon_MeV.toFixed(3) : "—" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 tabular-nums text-right pr-4", children: n.abundance != null ? n.abundance.toFixed(3) : "—" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 tabular-nums text-right pr-4 font-mono text-xs", children: n.atomicMass_AMU != null ? n.atomicMass_AMU.toFixed(6) : "—" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 tabular-nums text-right pr-4 text-xs text-muted-foreground", children: n.Qvalue_MeV != null ? n.Qvalue_MeV.toFixed(3) : "—" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 text-xs text-muted-foreground", children: n.branchingRatios && n.branchingRatios.length > 0 ? n.branchingRatios.map((r) => `${r.toFixed(1)}%`).join(", ") : "—" })
                    ]
                  },
                  n.symbol
                )) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 border-t border-border px-4 py-3 bg-muted/20", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-muted-foreground min-w-[90px] text-center", children: [
                "Page ",
                page,
                " of ",
                totalPages
