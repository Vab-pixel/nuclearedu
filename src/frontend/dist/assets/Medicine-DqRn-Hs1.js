import { j as jsxRuntimeExports, P as PageHeader, S as SectionCard, E as EquationBlock, i as SafetyCallout, r as reactExports, A as AudienceBadge, h as ChevronDown, g as ChevronRight } from "./index-DWzjlv-D.js";
import { I as InlineEquation } from "./InlineEquation-m3CTHgTH.js";
import { N as NuclearNotation } from "./NuclearNotation-Cc69DMlI.js";
...
function InfoBox({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-muted/30 border border-border p-4 text-sm mb-4", children: [
    title && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground mb-2", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2", children: items.map(([k, v]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionCard, { "data-ocid": "medicine.overview_card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed mb-3", children: [
          ...
          " ",
          "are performed annually worldwide, growing at ~5% per year driven by ageing populations, increasing cancer incidence, and the dramatic expansion of targeted radionuclide therapy (IAEA Nuclear Medicine Database, 2022)."
        ] }),
        ...
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed mb-4", children: [
              "Understanding radiobiology is essential for nuclear medicine practitioners. Ionizing radiation kills cells primarily through DNA double-strand breaks (DSBs). The biological effectiveness of radiation depends heavily on how densely it deposits energy along its track — described by",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Linear Energy Transfer (LET)" }),
              " ",
              "in keV/μm."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-2", children: "Absorbed Dose and Effective Dose" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              EquationBlock,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: "RBE and LET in Nuclear Medicine" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DataTable,
              {
                headers: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: "The Linear No-Threshold (LNT) Model" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed mb-3", children: [
              ...
              " (As Low As Reasonably Achievable) and the LNT (Linear No-Threshold) model, which assumes cancer risk is proportional to dose with no safe threshold. In nuclear medicine, patient doses are explicitly justified: the diagnostic benefit must outweigh the small radiation risk."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-muted/20 border border-border p-4 text-sm text-muted-foreground mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground block mb-1", children: "Typical Patient Doses (Effective Dose)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2 mt-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Sources: ICRP Publication 128 (Radiation Dose to Patients from Radiopharmaceuticals, 2015); SNMMI dosimetry guidelines; NRC nuclear medicine regulatory guides (10 CFR 35)." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Selecting a radionuclide for diagnostic nuclear medicine requires optimizing across physical, chemical, and biological constraints simultaneously. No isotope is perfect; each represents a compromise." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-2", children: "Physical Selection Criteria" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 mb-5 text-sm text-muted-foreground", children: [
              {
                criterion: "Half-life",
                optimal: "Similar to examination duration (~1–24 hours for SPECT; ~2 h for PET)",
                reason: "Too short: insufficient time for distribution and imaging. Too long: unnecessary patient dose after imaging complete."
              },
              {
                criterion: "Gamma energy",
                optimal: "100–250 keV for SPECT; 511 keV for PET",
                reason: "Below 100 keV: excessive tissue attenuation. Above 400 keV: poor NaI crystal detection efficiency; collimator penetration."
              },
              {
                criterion: "Emission purity",
                optimal: "Minimal particulate emissions (no α, minimal β)",
                reason: "Alpha/beta particles increase absorbed dose without contributing to the image. Pure γ or IT emitters minimize unnecessary irradiation."
              },
              {
                criterion: "Specific activity",
                optimal: "As high as possible (GBq/μmol)",
                reason: "Low specific activity means too many non-radioactive 'cold' molecules competing with labeled molecules for receptor binding sites, reducing image quality and dose calculations."
              },
              {
                criterion: "Availability",
                optimal: "Generator-based or regional cyclotron distribution",
                reason: "Short-lived nuclides require on-site production or rapid logistics; clinical programs require reliable 24/7 supply chains."
              }
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground w-32 shrink-0", children: item.criterion }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-foreground/80 font-medium", children: [
                      "Optimal: ",
                      item.optimal
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs mt-0.5", children: item.reason })
                  ] })
                ] })
              },
              item.criterion
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-2", children: "Why Tc-99m is the Perfect SPECT Nuclide" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: "Tc-99m satisfies nearly every criterion simultaneously — its discovery and development as a universal radiolabelling scaffold is one of the great achievements of applied nuclear science:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              InfoBox,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(NuclearNotation, { A: 18, Z: 9, symbol: "F" }),
              ": The Dominant PET Radionuclide"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: [
              "F-18 has emerged as the dominant PET radionuclide due to a unique combination of favourable properties. Production via",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "{}^{18}\\text{O}(p,n){}^{18}\\text{F}" }),
              " at 16–18 MeV proton energies in medical cyclotrons yields 50–150 GBq per 30-minute bombardment from H₂¹⁸O targets. The decay equation is:"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              EquationBlock,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(NuclearNotation, { A: 68, Z: 31, symbol: "Ga" }),
              ": Generator-Based PET Without a Cyclotron"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "{}^{68}\\text{Ga}" }),
              " (T½ = 67.7 min) has transformed PET access at hospitals without on-site cyclotrons. The",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "{}^{68}\\text{Ge}/{}^{68}\\text{Ga}" }),
              " generator (",
              /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "{}^{68}\\text{Ge}" }),
              " T½ = 270.95 days; daughter ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(InlineEquation, { tex: "{}^{68}\\text{Ga}" }),
              " by electron capture) provides reliable daily supply for 1–2 years per generator, enabling PSMA and DOTATATE PET programs at institutions globally. ⁶⁸Ga chelates readily with DOTA-peptide conjugates (DOTATATE, DOTATOC, PSMA-11) via rapid kit-based chemistry at room temperature."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Sources: IAEA Radiopharmacy: A Technologist's Guide (2014); Decristoforo et al., Eur J Nucl Med (2021); Velikyan I., Molecules (2015)." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          ocid: "medicine.spect",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "SPECT (Single Photon Emission Computed Tomography) accounts for ~75% of all nuclear medicine scans globally. Two or three NaI(Tl) detector heads rotate around the patient; lead collimators define photon directionality; iterative OSEM reconstruction generates 3D radiotracer distribution maps at ~10–15 mm spatial resolution." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-2", children: "Common SPECT Applications and Tracers" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DataTable,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-muted-foreground", children: "Sources: SNM/EANM procedural guidelines; IAEA Human Health Reports; SNMMI Image Gently data." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: "Mo-99/Tc-99m Global Supply Chain" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DataTable,
              {
                headers: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2", children: "Accelerator-based Mo-99 (SHINE Medical Technologies, WI, USA) now supplements reactor supply via photofission of U solutions with electron linear accelerators (OECD/NEA Mo-99 Security of Supply Report, 2022)." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed mb-4", children: [
              "PET achieves higher spatial resolution and sensitivity than SPECT by exploiting positron-electron annihilation physics. The",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "two 511 keV photons emitted simultaneously at 180°" }),
              " ",
              "enable electronic collimation via coincidence detection, giving PET 10–100× greater sensitivity."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              EquationBlock,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: "Key PET Tracers" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DataTable,
              {
                headers: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Targeted radionuclide therapy (TRT) delivers therapeutic radiation specifically to cancer cells by attaching a therapeutic radionuclide to a targeting vector that preferentially accumulates in tumour tissue via specific biological uptake. Radiation — typically beta or alpha particles — destroys cancer cells from within, while the short emission range limits damage to surrounding healthy tissue." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-2", children: "Particle Types and Radiobiology" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DataTable,
              {
                headers: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: "Iodine-131: Nuclear Medicine's Oldest Success" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-3", children: "The thyroid gland concentrates iodine via the sodium-iodide symporter (NIS) protein for thyroid hormone synthesis. I-131 exploits this selectivity: first used clinically in 1941 (Hertz and Roberts, MGH Boston) — the oldest targeted radionuclide therapy in clinical use." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              InfoBox,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-2", children: "¹⁷⁷Lu-DOTATATE (Lutathera®): NETs" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed mb-3", children: [
              "Neuroendocrine tumours overexpress somatostatin receptors (SSTR2) at 10–1,000× higher density than normal tissue. The NETTER-1 Phase III RCT (Strosberg et al., ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "N Engl J Med" }),
              ", 2017) established the evidence base:"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              InfoBox,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-2", children: "¹⁷⁷Lu-PSMA-617 (Pluvicto®): Prostate Cancer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DataTable,
              {
                headers: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-2", children: "²²³Ra-Dichloride (Xofigo®): Alpha Therapy" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              EquationBlock,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm mb-3", children: [
              "ALSYMPCA Phase III (Parker et al., ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "N Engl J Med" }),
              ", 2013): median OS 14.9 vs. 11.3 months, HR 0.695 (p<0.001). FDA approved 2013 — first targeted alpha emitter approved for systemic cancer therapy globally."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-2", children: "Approved Radionuclide Therapies" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DataTable,
              {
                headers: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Short half-lives that make isotopes clinically useful simultaneously create formidable supply chain challenges. Isotopes must be produced continuously in dedicated facilities (reactors or cyclotrons), processed under aseptic and radiation safety conditions, quality-tested, and shipped worldwide within hours to days." }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: "Medical cyclotrons (typically 11–30 MeV proton energy) at hospital sites or regional radiopharmacies produce short-lived PET nuclides. Global fleet: ~1,500 medical cyclotrons (IAEA, 2023)." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DataTable,
              {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Nuclear medicine dosimetry quantifies the absorbed dose received by patients, caregivers, and occupationally exposed staff. Regulatory oversight ensures procedures are justified and optimized per the ALARA principle." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-2", children: "Patient Dosimetry: The MIRD Formalism" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              EquationBlock,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: "Regulatory Framework (USA and International)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 text-sm text-muted-foreground mb-4", children: [
              {
              ...
              "div",
              {
                className: "rounded-lg bg-muted/20 border border-border p-3",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground", children: item.body }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: item.role })
                ]
              },
              item.body
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SafetyCallout, { title: "Radiation Safety in Therapeutic Nuclear Medicine", children: "High-activity radiopharmaceutical therapies (¹³¹I thyroid ablation ≥30 mCi; ¹⁷⁷Lu-PSMA-617, ¹⁷⁷Lu-DOTATATE) require patient isolation, lead shielding of waste, and restricted contact with pregnant women and children for 1–7 days post-treatment. Facilities must meet NRC 10 CFR 35 requirements for RAM licensing, written directives, and post-therapy surveying. Emergency procedures for unintended dose are mandatory." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CollapsibleSection,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed mb-4", children: [
              "The next decade in nuclear medicine will be defined by two convergent trends: the clinical maturation of",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "targeted alpha therapy (TAT)" }),
              " ",
              "and the proliferation of",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "theranostic pairs" }),
              " ",
              "across more tumour types. Together they represent the most precise radiation delivery platform in oncology."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-2", children: "Actinium-225: Next-Generation Alpha Therapy" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: "Ac-225 (T½ = 9.92 days; 4 alpha particles in decay to stable Bi-209) is the most clinically advanced next-generation alpha emitter. Ac-225-PSMA-617 showed remarkable results in compassionate-use series in patients who failed Lu-177-PSMA treatment. Key challenges limiting wider clinical adoption:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DataTable,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: "The Theranostics Pipeline (2024–2030)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DataTable,
              {
                headers: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mt-5 mb-2", children: "Terbium Isotopes: A Theranostic Quadruplet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: "The terbium (Tb) element uniquely provides four isotopes usable in a single theranostic strategy — all chelated with the same DOTANOC ligand at the same geometry, guaranteeing identical pharmacokinetics:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4", children: [
              {
                iso: "¹⁴⁹Tb (α)",
                "T½": "4.12 h",
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground mt-1", children: t.use })
                ]
              },
              t.iso
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "Sources: Müller C. et al. (2019) ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "J Nucl Med" }),
              " 60, 1457; Baum R.P. et al. (2021) ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "J Nucl Med" }),
              " 62(suppl 3); Sartor et al. (2021) ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "N Engl J Med" }),
              " 385, 1091. Fusion Industry Association (2023); SNMMI 2024 Annual Meeting abstracts."
            ] })
          ]
        }
      )
