...
export const newsItems: NewsItem[] = [
  // ── FUSION ──────────────────────────────────────────────────────────────────
  {
    ...
    summary:
      "On December 5, 2022, scientists at Lawrence Livermore National Laboratory's National Ignition Facility produced 3.15 megajoules of fusion energy using only 2.05 MJ of laser energy—crossing the ignition threshold for the first time. This milestone, decades in the making, demonstrates that controlled thermonuclear fusion can yield more energy than the driver delivers to the fuel capsule. The result was independently validated and published in Physical Review Letters in February 2023.",
    date: "2022-12",
    category: "fusion",
  ...
  },
  {
    ...
    title:
      "Commonwealth Fusion Sciences Demonstrates Record High-Temperature Superconducting Magnet",
    summary:
      "In September 2022, Commonwealth Fusion Sciences (CFS) and MIT's PSFC successfully tested a 20-tesla REBCO high-temperature superconducting (HTS) magnet—the strongest of its type ever built. This proof-of-concept underpins the SPARC compact tokamak design, which aims to achieve net energy fusion in a device far smaller than ITER. CFS raised $1.8 billion in Series B funding in late 2021 to advance toward a commercial fusion plant called ARC.",
    date: "2022-09",
    category: "fusion",
  ...
  },
  {
    ...
    title:
      "X-energy Advances TRISO Fuel Production for Xe-100 High-Temperature Reactor",
    summary:
      "X-energy announced in 2024 that its TRISO-X fuel fabrication facility in Oak Ridge, Tennessee received NRC license approval and began producing TRISO (Tristructural Isotropic) fuel pebbles for its Xe-100 pebble-bed high-temperature gas reactor. TRISO fuel's robust ceramic coating makes it highly resistant to meltdown and radiation damage. DOE supports the Xe-100 under ARDP with up to $1.2 billion in funding.",
    date: "2024-03",
    category: "technology",
    source: "DOE / X-energy",
  ...
  // ── MEDICINE ────────────────────────────────────────────────────────────────
  {
    ...
    title:
      "Lutetium-177 DOTATATE Expands Use as Targeted Radiotherapy for Neuroendocrine Tumors",
    summary:
  ...
  },
  {
    ...
    title:
      "FDA Approves Flortaucipir F-18 PET Imaging for Alzheimer's Disease Tau Pathology",
    summary:
      "The FDA approved flortaucipir F-18 (Tauvid®) as the first PET imaging agent to detect tau neurofibrillary tangles associated with Alzheimer's disease in living patients. The radiopharmaceutical binds to tau aggregates in the brain and enables non-invasive diagnosis that previously required autopsy confirmation. Its approval accelerates clinical trials of tau-targeting therapeutics and enables earlier intervention in the disease course.",
    date: "2022-07",
    category: "medicine",
    source: "FDA",
  ...
  // ── SAFETY ──────────────────────────────────────────────────────────────────
  {
    ...
    title:
      "IAEA Conducts Record Number of Nuclear Safety Review Missions in 2023",
    summary:
      "The International Atomic Energy Agency conducted a record 138 safety review missions in 2023, including OSART (Operational Safety Review Team) and IRRS (Integrated Regulatory Review Service) missions to 40 member states. Reviews covered operating reactors, regulatory frameworks, and radiation source security. The increased mission pace reflects growing global interest in nuclear safety culture strengthening ahead of a planned nuclear capacity expansion.",
    date: "2023-12",
    category: "safety",
    source: "IAEA",
  ...
  },
  {
    ...
    title:
      "Accident-Tolerant Fuel with Chromia-Doped UO₂ Pellets Completes Lead Test Assemblies",
    summary:
      "Framatome and Westinghouse both completed in-reactor lead test assemblies of accident-tolerant fuel (ATF) designs in 2023, including chromia-doped uranium dioxide pellets and FeCrAl cladding variants. Chromia doping increases fuel pellet strength and creep resistance, reducing pellet-cladding interaction failures. Post-irradiation examinations at the 2023 milestone confirmed expected performance improvements, with commercial deployment targeted before 2030.",
    date: "2023-07",
    category: "safety",
    source: "DOE / NRC",
  ...
  },
  {
    ...
    title:
      "Finland's Onkalo Deep Geological Repository Licensed for High-Level Waste Disposal",
    summary:
      "Finland's Radiation and Nuclear Safety Authority (STUK) approved the construction license for Onkalo, the world's first operational deep geological repository for high-level nuclear waste, in 2023. The KBS-3 design encapsulates spent fuel in copper canisters surrounded by bentonite clay, buried 400 m deep in stable bedrock. Waste emplacement is planned to begin in the 2020s, offering a tested model for permanent nuclear waste disposal.",
    date: "2023-04",
    category: "safety",
    source: "STUK / Posiva",
  ...
  // ── RESEARCH ────────────────────────────────────────────────────────────────
  {
    ...
    title:
      "Neutron Scattering Reveals Quantum Spin Liquids in Frustrated Magnets",
    summary:
      "Researchers using neutron scattering facilities at Oak Ridge National Laboratory (ORNL) and ILL Grenoble published landmark 2023 results identifying genuine quantum spin liquid behavior in frustrated kagome-lattice magnets. Neutrons are uniquely sensitive to magnetic structures due to their spin, making nuclear reactor–based neutron sources irreplaceable for this class of materials science. The findings have implications for topological quantum computing.",
    date: "2023-05",
    category: "research",
  ...
  },
  {
    ...
    title:
      "IAEA Promotes Nuclear Desalination as Freshwater Solution for Water-Stressed Nations",
    summary:
      "The IAEA's 2023 nuclear desalination update highlighted that 22 countries are actively studying nuclear desalination pairing, with South Korea's SMART reactor demonstrating co-generation of electricity and potable water. Nuclear plants' low-cost thermal energy can drive multi-effect distillation (MED) or reverse osmosis processes economically. The IAEA coordinated research program involves pilot studies in Saudi Arabia, China, and the UAE.",
    date: "2023-06",
    category: "research",
    source: "IAEA",
  ...
  },
  {
    ...
    title:
      "High-Temperature Gas Reactors Advance as Hydrogen Production Platforms",
    summary:
  ...
  // ── HISTORY ─────────────────────────────────────────────────────────────────
  {
    ...
    title:
      "80th Anniversary of Chicago Pile-1: The World's First Artificial Nuclear Reactor",
    summary:
      "December 2, 2022 marked the 80th anniversary of Chicago Pile-1 (CP-1) achieving the world's first self-sustaining nuclear chain reaction under the west stands of Stagg Field at the University of Chicago. Enrico Fermi and a team of 49 scientists operated the graphite-moderated, natural uranium reactor for 28 minutes at a power of about 0.5 W. The event validated nuclear fission theory and directly enabled both the Manhattan Project and the later development of civilian nuclear power.",
    date: "2022-12",
    category: "history",
  ...
  },
  {
    ...
    summary:
      "In September 2023, Microsoft and Constellation Energy announced a 20-year power purchase agreement to restart Three Mile Island Unit 1 (which operated 1974–2019 and is separate from the Unit 2 that had the 1979 accident), renamed the Crane Clean Energy Center. The 837 MWe plant is expected to return to service in 2028, supplying carbon-free electricity for Microsoft's data centers. The deal exemplifies a new trend of tech companies driving nuclear power demand.",
    date: "2023-09",
    category: "history",
  ...
  },
  {
    ...
    title:
      "New Research Maps Chernobyl Exclusion Zone Wildlife Recovery After 37 Years",
    summary:
  ...
  // ── ADDITIONAL RESEARCH/TECHNOLOGY ──────────────────────────────────────────
  {
    ...
    title:
      "DOE Advances Versatile Test Reactor for Fast-Neutron Fuel and Materials Testing",
    summary:
  ...
  },
  {
    ...
    title:
      "Nuclear Operators Begin Piloting AI-Assisted Monitoring for Plant Operations",
    summary:
      "Several US and French nuclear plant operators in 2024 began pilot programs using machine learning models to monitor plant sensor data for early anomaly detection, predictive maintenance alerts, and thermal efficiency optimization. Oak Ridge National Laboratory and EDF published results showing AI models can identify degrading pumps and heat exchanger fouling weeks before traditional alarm thresholds would trigger. Regulatory frameworks for AI in safety-critical systems are being developed by the NRC and IRSN.",
    date: "2024-05",
    category: "technology",
    source: "ORNL / EDF / NRC",
