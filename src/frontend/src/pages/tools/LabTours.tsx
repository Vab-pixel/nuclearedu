...
interface TourCard {
  ...
  location: string;
  facilityType: string;
  facilityTypeColor: string;
  icon: React.ReactNode;
  description: string;
  embedType: "youtube" | "sketchfab" | "placeholder";
  embedSrc: string;
  externalLink: string;
  stats: FacilityStat[];
  facts: string[];
...
const TOURS: TourCard[] = [
  {
    ...
    description:
      "Home of the Large Hadron Collider — a 27 km underground ring where protons collide at 99.9999991% of the speed of light. The world's most powerful particle accelerator, enabling discovery of the Higgs boson in 2012.",
    embedType: "sketchfab",
    embedSrc:
      "https://sketchfab.com/models/e267b7c7cdd040a99c8a1ad9f0c7ed34/embed?autostart=1&ui_theme=dark&ui_infos=0&ui_watermark=0",
    ...
    researchFocus:
      "Fundamental particle physics — studying the building blocks of matter and the forces that govern the universe at the smallest scales.",
  },
  {
    id: "iter-tokamak",
    ...
    description:
      "The world's largest experimental fusion reactor under construction, designed to demonstrate that fusion power can produce 10× more energy than it consumes. A global collaboration of 35 nations aiming to deliver 500 MW from 50 MW input.",
    embedType: "youtube",
    embedSrc:
      "https://www.youtube.com/embed/9T1DikXVbIg?rel=0&modestbranding=1",
    ...
    researchFocus:
      "Demonstrating net-energy-gain fusion at scale — the critical step toward commercial fusion power plants that could provide virtually unlimited clean energy.",
  },
  {
    id: "nif-laser",
    ...
    icon: <Zap className="h-5 w-5" />,
    description:
      "Lawrence Livermore National Laboratory's laser fusion facility — the world's largest and most energetic laser system. In December 2022, NIF achieved the first-ever fusion ignition, producing more fusion energy than the laser energy delivered to the target.",
    embedType: "youtube",
    embedSrc:
      "https://www.youtube.com/embed/bQ4kfMIFWx4?rel=0&modestbranding=1",
    ...
    researchFocus:
      "Inertial confinement fusion (ICF) — studying the physics of nuclear weapons without underground testing, and developing laser-driven fusion energy.",
  },
  {
    ...
    description:
      "Lawrence Berkeley National Laboratory's 88-Inch Cyclotron — one of the world's oldest particle accelerators still in active operation. A pioneering facility for nuclear science, isotope production, and heavy-ion physics since 1961.",
    ...
    researchFocus:
      "Nuclear structure, heavy-ion collisions, superheavy element synthesis, isotope production for medicine and materials research, and radiation effects in electronics.",
  },
  {
    id: "jet-tokamak",
    ...
    icon: <Radio className="h-5 w-5" />,
    description:
      "The Joint European Torus at Culham Centre for Fusion Energy — the world's largest operational tokamak until its retirement in 2023. JET held the world record for fusion energy output (59 megajoules in February 2022) and was a key proving ground for ITER design choices.",
    embedType: "youtube",
    embedSrc:
      "https://www.youtube.com/embed/TlKGCp8tEUk?rel=0&modestbranding=1",
    ...
    researchFocus:
      "Magnetic confinement fusion — validating plasma physics models, DT fuel performance, and materials testing under fusion-neutron bombardment for ITER and future fusion power plants.",
  },
  {
    id: "slac-linac",
    ...
    description:
      "Stanford Linear Accelerator Center's 3.2 km linear accelerator — the longest linac in the world. Originally built to accelerate electrons for particle physics, it now drives the Linac Coherent Light Source (LCLS), the world's first and most powerful X-ray free-electron laser.",
    embedType: "placeholder",
    embedSrc: "",
    ...
    researchFocus:
      "Structural biology, materials science, ultrafast chemistry, and astrophysics via X-ray free-electron laser pulses of unprecedented brightness and brevity.",
  },
];
...
function EmbedFrame({ tour }: { tour: TourCard }) {
  const [failed, setFailed] = useState(false);

  if (tour.embedType === "placeholder" || failed) {
    return (
      <div className="flex flex-col items-center justify-center h-56 bg-muted/30 rounded-lg border border-border/50 gap-4 p-4">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-muted-foreground max-w-xs">
            Visit the official site for immersive 360° tours and interactive
            models of this facility.
          </p>
        </div>
        <Button
          type="button"
          ...
          size="sm"
          onClick={() =>
            window.open(tour.externalLink, "_blank", "noopener,noreferrer")
          }
      ...
      <div className="flex flex-col flex-1 p-5 gap-4">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            <span className="flex-shrink-0 flex items-center justify-center h-9 w-9 rounded-full bg-primary/10 border border-primary/20 text-primary">
              {tour.icon}
            </span>
        ...
        {/* Research focus */}
        <div className="mt-auto rounded-md bg-primary/5 border border-primary/15 p-3">
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.12 0.04 260) 0%, oklch(0.08 0.02 240) 100%)",
        }}
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url(/assets/generated/lab-tours-hero.dim_1200x400.jpg)",
        ...
        >
          {[...Array(20)].map((_, particleIdx) => (
            <motion.div
              // biome-ignore lint/suspicious/noArrayIndexKey: decorative animation-only elements with no stable IDs; order is fixed
      ...
      >
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-1.5 text-xs text-muted-foreground rounded-md bg-muted/40 border border-border/40 px-3 py-1.5">
        ...
        >
          {TOURS.map((tour, i) => (
            <li key={tour.id}>
              <TourCardComponent tour={tour} index={i} />
            </li>
          ))}
        </ul>
      </section>
      ...
      <section className="bg-muted/20 border-t border-border/40">
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-start gap-3 max-w-3xl">
            <BookOpen className="h-4 w-4 text-primary/60 mt-0.5 flex-shrink-0" />
            <div>
              <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">
                Educational Sources
              </p>
              <p className="text-xs text-muted-foreground leading-relaxed">
                All embedded tours and videos are sourced from official facility
                channels (CERN, ITER Organization, Lawrence Livermore National
                Laboratory, EUROfusion, SLAC National Accelerator Laboratory)
                and are provided for educational purposes under their respective
                open-access or public communications policies. 3D models via
                Sketchfab are shared under Creative Commons licenses where
                applicable.
              </p>
            </div>
          </div>
